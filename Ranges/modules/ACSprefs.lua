...
local defaults = {
    ...
    { name = "Other", settings = {
		...
		{ key="isPreviewReclaimrange", type="bool", default=false, name="Preview reclaimrange (alt)", description="Shows the attackmove reclaim ranges as if the selected units were located at the cursor position" },
