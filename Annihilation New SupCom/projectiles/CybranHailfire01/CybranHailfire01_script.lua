...
local CybranHailfire02Projectile = import('/mods/Annihilation New SupCom/lua/EXBlackOpsprojectiles.lua').CybranHailfire02Projectile
local TMissileCruiseProjectile = import('/mods/Annihilation New SupCom/lua/EXBlackOpsprojectiles.lua').UEFACUClusterMIssileProjectile
   ...
   OnCreate = function(self)
    ...
    SetTurnRateByDist = function(self)
        ...
        if dist > 0 and dist <= 15 then
            ...
            local ChildProjectileBP = '/mods/Annihilation New SupCom/projectiles/CybranHailfire01child/CybranHailfire01child_proj.bp'
