-------------------------------------------------------------------------------
--
--  File     :  /mods/Hyper Experimental Tier/projectiles/NapalmWild/NAPALMWILD_script.lua
--  Author(s):  Alek
--
--  Summary  :  Wildfire Napalm Bomb, Wildfire
-------------------------------------------------------------------------------
...
NAPALMWILD = Class(TNapalmHvyCarpetBombProjectile) {
