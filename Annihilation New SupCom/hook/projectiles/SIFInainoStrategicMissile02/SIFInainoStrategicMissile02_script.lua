...
if version >= 1 then
	LOG('Annihilation New SupCom (Preservation): [SIFInainoStrategicMissile02_script.lua '..debug.getinfo(1).currentline..'] - Gameversion is 3652 or newer. Hooking "SIFInainoStrategicMissileEffect02".')
	

#****************************************************************************
#**
#**  File     :  /projectiles/SIFInainoStrategicMissile02/SIFInainoStrategicMissile02_script.lua
...
TypeClass = SIFInainoStrategicMissile02
	...
	LOG('Annihilation New SupCom (Preservation): [SIFInainoStrategicMissile02_script.lua '..debug.getinfo(1).currentline..'] - Gameversion is older then 3652. No need to hook "SIFInainoStrategicMissile02".')
end