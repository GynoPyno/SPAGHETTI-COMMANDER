...
if version >= 1 then
	LOG('Annihilation New SupCom (Preservation): [SIFInainoStrategicMissileEffect01_script.lua '..debug.getinfo(1).currentline..'] - Gameversion is 3652 or newer. Hooking "SIFInainoStrategicMissile01".')
...
TypeClass = SIFInainoStrategicMissile01
	...
	LOG('Annihilation New SupCom (Preservation): [SIFInainoStrategicMissileEffect01_script.lua '..debug.getinfo(1).currentline..'] - Gameversion is older then 3652. No need to hook "SIFInainoStrategicMissile01".')
end