...
MiniQuantumBeamGeneratorCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/hook/effects/mini_quantum_generator_beam_01_emit.bp'},
    FxBeamEndPoint = {
...
MiniPhasonLaserCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/hook/effects/mini_phason_laser_beam_01_emit.bp'},
    FxBeamStartPointScale = 0.2,
...
MiniMicrowaveLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeamStartPointScale = 0.2,
    FxBeam = {'/mods/Annihilation New SupCom/hook/effects/mini_microwave_laser_beam_01_emit.bp'},
