...
Weapons = {
    ...
    BeamExhaustIdle = '/mods/Annihilation New SupCom/effects/emitters/gunship_thruster_beam_03_emit.bp',
	BeamExhaustCruise = '/mods/Annihilation New SupCom/effects/emitters/gunship_thruster_beam_03_emit.bp',
