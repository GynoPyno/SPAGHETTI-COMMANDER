...
VOS0033 = ClassUnit(CWalkingLandUnit) {
    WalkingAnimRate = 1.2,
    ...
    DeathThread = function(self)
        ...
        explosion.CreateFlash(self, 'URL0402', 4.5, army)
        ...
        CreateFirePlumes(self, army, { 'URL0402' }, 0)
        ...
        CreateDefaultHitExplosionAtBone(self, 'URL0402', 1.5)
        CreateDamageEmitters(self, 'URL0402', army, 1.5)
        CreateDamageEmitters(self, 'URL0402', army, 1.5)
        ...
        CreateDefaultHitExplosionAtBone(self, 'URL0402', 1)
        for k, v in EffectTemplate.FootFall01 do
            CreateAttachedEmitter(self, 'URL0402', army, v):ScaleEmitter(2)
            CreateAttachedEmitter(self, 'URL0402', army, v):ScaleEmitter(2)
        end
        ...
        CreateDefaultHitExplosionAtBone(self, 'URL0402', 2)
        DamageRing(self, { x, y, z }, 0.1, 3, 1, 'TreeForce', true)
