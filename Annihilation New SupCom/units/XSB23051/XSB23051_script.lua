...
XSB23051 = Class(TStructureUnit) {
    ...
    OpenState = State() {
        ...
        Main = function(self)            
            ...
            self.AnimManip:PlayAnim( '/units/XSB2305/XSB2305_aopen.sca' )
            ...
            local location = self:GetPosition('Projectile01')
            ...
            if newSat then
                ...
                self.Satellite:AttachTo(self, 'Projectile01')
            end
