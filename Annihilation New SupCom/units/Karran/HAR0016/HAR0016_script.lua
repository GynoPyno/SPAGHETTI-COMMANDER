...
local TDFHeavyPlasmaCannonWeapon = import('/mods/Annihilation New SupCom/lua/EXBlackOpsweapons.lua').UEFACUHeavyPlasmaGatlingCannonWeapon
local TIFCruiseMissileLauncher = WeaponFile.TIFCruiseMissileLauncher
local EffectUtils = import('/lua/effectutilities.lua')
local Effects = import('/lua/effecttemplates.lua')

HAR0016 = Class(TSubUnit) {
