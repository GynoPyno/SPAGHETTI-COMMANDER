...
local SeraLambdaField = import('/mods/Annihilation New SupCom/lua/BlackOpsdefaultantiprojectile.lua').SeraLambdaFieldDestroyer
local TerranWeaponFile = import('/lua/terranweapons.lua')
local DeathNukeWeapon = import('/lua/sim/defaultweapons.lua').DeathNukeWeapon


HAR0013 = Class(SStructureUnit) {
    ...
    CoreEffectsCreation = function(self)
        self.Effect1 = CreateAttachedEmitter(self,0,self:GetArmy(), '/mods/Annihilation New SupCom/effects/emitters/exstar_01_emit.bp')
        self.Effect1:ScaleEmitter(0.15)
        WaitSeconds(2)
        self.Effect2 = CreateAttachedEmitter(self,0,self:GetArmy(), '/mods/Annihilation New SupCom/effects/emitters/exstar_02_emit.bp')
