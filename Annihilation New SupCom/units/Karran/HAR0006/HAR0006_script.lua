...
local AirDroneCarrier = import('/mods/Annihilation New SupCom/lua/BlackOpsunits.lua').AirDroneCarrier
local Weapons2 = import('/mods/Annihilation New SupCom/lua/BlackOpsweapons.lua')
...
--HAR0006 = Class(BaseTransport, TWalkingLandUnit, AirDroneCarrier) {
HAR0006 = Class(TWalkingLandUnit, AirDroneCarrier) {
    FlamerEffects = '/mods/Annihilation New SupCom/effects/emitters/ex_flamer_torch_01.bp',
    ...
    CreateAmmoCookOff = function(self, Army, bones, yBoneOffset)
        ...
        for k, vBone in bones do
            ...
            ammocookoff = self:CreateProjectile('/mods/Annihilation New SupCom/projectiles/NapalmProjectile01/Napalm01_proj.bp', offset.x, offset.y + yBoneOffset, offset.z, velocity.x, velocity.y, velocity.z)
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/Annihilation New SupCom/effects/entities/GoliathNukeEffect03/GoliathNukeEffect03_proj.bp', x, HeightOffset, z, x, 0, z)
                :SetVelocity(velocity)
            table.insert(projectiles, proj)
        end
    ...
    DeathThread = function(self, overkillRatio , instigator)
        ...
        self:CreateProjectile('/mods/Annihilation New SupCom/effects/entities/GoliathNukeEffect01/GoliathNukeEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
