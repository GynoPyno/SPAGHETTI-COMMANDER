...
HAR0014 = Class(TEnergyCreationUnit) {
    ...
    CoreSpawn = function(self)
        ...
        local StellarCore = CreateUnit('HAR0013', self:GetArmy(), location[1], location[2], location[3], platOrient[1], platOrient[2], platOrient[3], platOrient[4], 'Land')
        table.insert (self.StellarCoreTable, StellarCore)
        StellarCore:AttachTo(self, 'star')
        StellarCore:SetParent(self, 'HAR0014')
