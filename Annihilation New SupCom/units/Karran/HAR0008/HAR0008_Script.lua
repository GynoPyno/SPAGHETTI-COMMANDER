...
local BasiliskNukeEffect04 = '/mods/Annihilation New SupCom/projectiles/MGQAIPlasmaArty01/MGQAIPlasmaArty01_proj.bp'
local BasiliskNukeEffect05 = '/mods/Annihilation New SupCom/effects/Entities/BasiliskNukeEffect05/BasiliskNukeEffect05_proj.bp'

local RandomFloat = import('/lua/utilities.lua').GetRandomFloat
local Util = import('/lua/utilities.lua')
local explosion = import('/lua/defaultexplosions.lua')
local EffectTemplate = import('/lua/EffectTemplates.lua')
local BlacOpsEffectTemplate = import('/mods/Annihilation New SupCom/lua/BlackOpsEffectTemplates.lua')
local CreateDeathExplosion = explosion.CreateDefaultHitExplosionAtBone

HAR0008 = Class(CWalkingLandUnit) {
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/Annihilation New SupCom/effects/entities/BasiliskNukeEffect03/BasiliskNukeEffect03_proj.bp', x, HeightOffset, z, x, 0, z)
    ...
    DeathThread = function(self)
       ...
       WaitSeconds(1)
        ...
        self:CreateProjectile('/mods/Annihilation New SupCom/effects/entities/BasiliskNukeEffect01/BasiliskNukeEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
