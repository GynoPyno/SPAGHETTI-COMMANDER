...
local RailGunWeapon02 = import('/mods/Annihilation New SupCom/lua/BlackOpsWeapons.lua').RailGunWeapon02
local CitadelHVMWeapon = import('/mods/Annihilation New SupCom/lua/BlackOpsWeapons.lua').CitadelHVMWeapon
local CitadelPlasmaGatlingCannonWeapon = import('/mods/Annihilation New SupCom/lua/BlackOpsWeapons.lua').CitadelPlasmaGatlingCannonWeapon
local EffectUtils = import('/lua/effectutilities.lua')
local Effects = import('/lua/effecttemplates.lua')

HAR0003 = Class(TAirUnit) {
    Weapons = {
