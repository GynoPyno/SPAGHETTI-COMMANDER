...
URB23051 = Class(TStructureUnit) {
    ...
    OpenState = State() {
        ...
        Main = function(self)            
            ...
            self.AnimManip:PlayAnim( '/units/URB2305/URB2305_aopen.sca' )
            ...
            local location = self:GetPosition('Projectile')
            ...
            self.Trash:Add(CreateAttachedEmitter(self,'B01',army, '/effects/emitters/light_red_rotator_01_emit.bp'):ScaleEmitter( 2.00 ))
            self.Trash:Add(CreateAttachedEmitter(self,'B02',army, '/effects/emitters/light_red_rotator_01_emit.bp'):ScaleEmitter( 2.00 ))
            
            if newSat then
                self.Satellite = CreateUnitHPR('XEA0003', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
                self.Trash:Add(self.Satellite)
                self.Satellite:AttachTo(self, 'Projectile')
            end
