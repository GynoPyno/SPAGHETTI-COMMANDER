...
local EXEffectTemplate = import('/mods/Annihilation New SupCom/lua/EXBlackOpsEffectTemplates.lua')

local EXCollisionBeam = import('/mods/Annihilation New SupCom/lua/EXCollisionBeam.lua').CollisionBeam
...
CybranSSBeam = Class(CybranBeamWeapons) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/exss_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
    FxBeamStartPointScale = 0.5,
    FxBeamEndPointScale = 0.5,
}
...
CybranAriesBeam01 = Class(CybranBeamWeapons) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/exaries_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
