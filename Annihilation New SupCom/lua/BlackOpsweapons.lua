...
local BlackOpsCollisionBeamFile = import('/mods/Annihilation New SupCom/lua/BlackOpsDefaultCollisionBeams.lua')
...
local MKCollisionBeamFile = import('/mods/Annihilation New SupCom/lua/BlackOpsdefaultcollisionbeams.lua')
...
RailGunWeapon01 = Class(DefaultProjectileWeapon) {
    FxChargeMuzzleFlash = {
        '/mods/Annihilation New SupCom/effects/emitters/x_cannon_charge_test_01_emit.bp',
    },
    FxMuzzleFlash = {
        '/mods/Annihilation New SupCom/effects/emitters/xcannon_cannon_muzzle_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/x_cannon_fire_test_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/jugg_rail_cannon_muzzle_07_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/jugg_rail_cannon_muzzle_08_emit.bp',
    },
...
ShadowCannonWeapon01 = Class(DefaultProjectileWeapon) {
    FxChargeMuzzleFlash = {
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_charge_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_charge_02_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_charge_05_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_charge_04_emit.bp',
    },

    FxMuzzleFlash = {
        '/mods/Annihilation New SupCom/effects/emitters/shadow_cannon_muzzle_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_cannon_muzzle_02_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_cannon_muzzle_05_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_cannon_muzzle_06_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_cannon_muzzle_07_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_cannon_muzzle_08_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_hit_10_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_flash_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_flash_02_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/shadow_muzzle_flash_03_emit.bp',
    },
...
BassieCannonWeapon01 = Class(DefaultProjectileWeapon) {
    ...
    FxMuzzleFlash = {
        '/mods/Annihilation New SupCom/effects/emitters/bassie_cannon_muzzle_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_cannon_muzzle_02_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_cannon_muzzle_05_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_cannon_muzzle_06_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_cannon_muzzle_07_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_cannon_muzzle_08_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_hit_10_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_muzzle_flash_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_muzzle_flash_02_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/bassie_muzzle_flash_03_emit.bp',
    },
    FxMuzzleFlashScale = 0.5,
    FxChargeMuzzleFlashScale = 1,
}
            ...
            if TableSize >= 1 then
                if TableSize == f_count then
                    ...
                    if not tar:BeenDestroyed() and not tar.Dead then
                        ...
                        CreateAttachedEmitter(tar, 0, tar:GetArmy(), '/mods/Annihilation New SupCom/effects/emitters/targeted_effect_01_emit.bp'):OffsetEmitter(0, 0.5,0)
                    end
                else
