...
local TMavaEffectTemplate = import('/mods/Annihilation New SupCom/lua/TMavaEffectTemplates.lua')
...
AeonBROT3NCM2proj = Class(MultiPolyTrailProjectile) {
	...
	PolyTrails  = {
            '/mods/Annihilation New SupCom/effects/emitters/AeonT3NCM2_polytrails_emit.bp',
	},
