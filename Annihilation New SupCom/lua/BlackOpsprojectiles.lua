...
TFragmentationGrenadeMK02 = Class(EmitterProjectile) {
    FxImpactUnit = BlackOpsEffectTemplate.THeavyFragmentationGrenadeHitMK,
    FxImpactLand = BlackOpsEffectTemplate.THeavyFragmentationGrenadeHitMK,
    FxImpactWater = BlackOpsEffectTemplate.THeavyFragmentationGrenadeHitMK,
    FxImpactNone = BlackOpsEffectTemplate.THeavyFragmentationGrenadeHitMK,
    FxImpactProp = BlackOpsEffectTemplate.THeavyFragmentationGrenadeHitMK,
    FxImpactUnderWater = {},
...
DOMINATORproj = Class(SinglePolyTrailProjectile) { -- SR
    ...
    PolyTrailOffset = {0,0},
    FxTrails = {'/mods/Annihilation New SupCom/effects/emitters/DOMINATOR_emit.bp',},
...
MiniRocket03PRojectile = Class(SingleBeamProjectile) {
    ...
    BeamName = '/mods/Annihilation New SupCom/effects/emitters/missile_munition_exhaust_beam_02_emit.bp',
...
MiniRocket04PRojectile = Class(SingleBeamProjectile) {
    DestroyOnImpact = false,
    BeamName = '/mods/Annihilation New SupCom/effects/emitters/missile_munition_exhaust_beam_03_emit.bp',
...
ShadowCannonProjectile = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
        '/mods/Annihilation New SupCom/effects/emitters/shadowcannon_polytrail_01_emit.bp',
    },
    PolyTrailOffset = {0,0},
...
Juggfire01 = Class(MultiPolyTrailProjectile) {
    ...
    FxTrails = {
        '/mods/Annihilation New SupCom/effects/emitters/Juggfire01_emit.bp',
...
NapalmProjectile01 = Class(EmitterProjectile) {
    FxTrails = {'/mods/Annihilation New SupCom/Effects/Emitters/NapalmTrailFX.bp',},
...
MGQAIRocketChildProjectile = Class(SingleCompositeEmitterProjectile) {
    PolyTrail = '/mods/Annihilation New SupCom/effects/emitters/mgqai_missile_trail_emit.bp',
    BeamName = '/mods/Annihilation New SupCom/effects/emitters/mgqai_missle_exhaust_beam_01_emit.bp',
    PolyTrailOffset = -0.05,
...
MGQAIPlasmaArtyProjectile = Class(EmitterProjectile) {
    ...
    FxImpactLand = {},
    FxImpactUnderWater = {},
    ChildProjectile = '/mods/Annihilation New SupCom/projectiles/MGQAIPlasmaArtyChild01/MGQAIPlasmaArtyChild01_proj.bp',
...
RaiderCannonProjectile = Class(SinglePolyTrailProjectile) {
    FxTrails = {
        ...
        '/mods/Annihilation New SupCom/effects/emitters/raider_cannon_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/raider_cannon_02_emit.bp',
    },
...
GargEMPWarheadProjectile = Class(NukeProjectile, SingleBeamProjectile) {
    ...
    OnImpact = function(self, targetType, targetEntity)
        ...
        for i = 0, (blanketSides-1) do
            local blanketX = math.sin(i*blanketAngle)
            local blanketZ = math.cos(i*blanketAngle)
            self:CreateProjectile('/mods/Annihilation New SupCom/effects/entities/EffectEMPAmbient01/EffectEMPAmbient01_proj.bp', blanketX, 0.5, blanketZ, blanketX, 0, blanketZ)
                :SetVelocity(blanketVelocity):SetAcceleration(-0.3)
        end
