...
ColossusLaserCollisionBeam = Class(MKCollisionBeam) {
    ...
    FxBeamStartPoint = BlackOpsEffectTemplate.AColossusLaserMuzzle01,
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/Colossus_laser_beam_01_emit.bp'},
    FxBeamStartPointScale = 0.3,
    FxBeamEndPoint = BlackOpsEffectTemplate.AColossusLaserImpact01,
...
MartyrMicrowaveLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/mini_microwave_laser_beam_01_emit.bp'},
...
MiniQuantumBeamGeneratorCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/mini_quantum_generator_beam_01_emit.bp'},
    FxBeamEndPoint = {
        '/effects/emitters/quantum_generator_end_01_emit.bp',
        '/effects/emitters/quantum_generator_end_03_emit.bp',
        '/effects/emitters/quantum_generator_end_04_emit.bp',
...
SuperQuantumBeamGeneratorCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/super_quantum_generator_beam_01_emit.bp'},
    FxBeamEndPoint = {
        '/effects/emitters/quantum_generator_end_01_emit.bp',
        '/effects/emitters/quantum_generator_end_03_emit.bp',
        '/effects/emitters/quantum_generator_end_04_emit.bp',
...
MiniPhasonLaserCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/mini_phason_laser_beam_01_emit.bp'},
    FxBeamStartPointScale = 0.2,
...
JuggLaserCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/jugg_laser_beam_01_emit.bp'},
    FxBeamEndPoint = {
        '/effects/emitters/quantum_generator_end_01_emit.bp',
        '/effects/emitters/quantum_generator_end_03_emit.bp',
        '/effects/emitters/quantum_generator_end_04_emit.bp',
...
RailLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeamStartPointScale = 0.2,
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/rail_microwave_laser_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
    FxBeamEndPointScale = 0.2,
    SplatTexture = 'czar_mark01_albedo',
    ScorchSplatDropTime = 0.25,
...
EMCHPRFDisruptorBeam = Class(HawkCollisionBeam) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeamStartPointScale = 0.3,
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/manticore_microwave_laser_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
...
TDFGoliathCollisionBeam = Class(HawkCollisionBeam) {
    ...
    TerrainImpactScale = 1,
    FxBeamEndPoint = {
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_end_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_end_02_emit.bp',
        ...
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_end_06_emit.bp',
        '/effects/emitters/uef_orbital_death_laser_end_07_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_end_08_emit.bp',
        '/effects/emitters/uef_orbital_death_laser_end_distort_emit.bp',
    },
    FxBeamStartPointScale = 1,
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_beam_01_emit.bp'},
    FxBeamStartPoint = {
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_muzzle_01_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_muzzle_02_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_muzzle_03_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_muzzle_04_emit.bp',
        '/mods/Annihilation New SupCom/effects/emitters/goliath_death_laser_muzzle_05_emit.bp',
    },
...
MGAALaserCollisionBeam = Class(HawkCollisionBeam) {
    FxBeam = {
        '/mods/Annihilation New SupCom/effects/emitters/aa_cannon_beam_01_emit.bp',
    },
    FxBeamEndPoint = {
...
GoldenLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/Annihilation New SupCom/effects/emitters/mini_golden_laser_beam_01_emit.bp'},
