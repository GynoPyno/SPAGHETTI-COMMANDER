...
AeonBROT3NCNlaserproj = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
        '/mods/Annihilation New SupCom/effects/emitters/novacat_bluelaser_emit.bp',
	},
	PolyTrailOffset = {0,0}, 
...
CybBRMT3MCM4RLproj = Class(MultiPolyTrailProjectile) {
	FxTrails  = {
            ...
            '/mods/Annihilation New SupCom/effects/emitters/w_u_gau03_p_04_smoke_emit.bp',
	},
	FxTrailOffset = 0.2,
	PolyTrails  = {
            '/mods/Annihilation New SupCom/effects/emitters/w_u_gau03_p_01_polytrails_emit.bp',
...
AeonBROT2EXTHproj = Class(MultiPolyTrailProjectile) {
	...
	PolyTrails  = {
            '/mods/Annihilation New SupCom/effects/emitters/AeonT2EXTH_polytrails_emit.bp',
	},
...
AeonBROT3SHPD2proj = Class(MultiPolyTrailProjectile) {
	...
	PolyTrails  = {
            '/mods/Annihilation New SupCom/effects/emitters/AeonT3SHPD_polytrails_emit.bp',
	},
    FxImpactUnit = TMEffectTemplate.AeonT2ExperimentalTankHunterHit01,
    FxUnitHitScale = 1.25,
    FxImpactProp = TMEffectTemplate.AeonT2ExperimentalTankHunterHit01,
...
UefBRNT2EXARTproj = Class(MultiPolyTrailProjectile) {
	PolyTrailOffset = {0.05,0.05,0.05},  
	PolyTrails  = {
            '/mods/Annihilation New SupCom/effects/emitters/UEFT2EXART_polytrails_emit.bp',
            '/mods/Annihilation New SupCom/effects/emitters/w_u_gau03_p_01_polytrails_emit.bp',
	},
...
CybBRMT3ADVBTBOTproj = Class(MultiPolyTrailProjectile) {
	...
	PolyTrails  = {
        '/mods/Annihilation New SupCom/effects/emitters/BRMT3ADVBTBOT_polytrails_emit.bp',
