--#****************************************************************************
--#**
--#**  File     :  /mods/Hyper Experimental Tier/units/ScrindleWald/XSB4301_script.lua
--#**
--#**  Summary  :  Seraphim Ultra Heavy Shield Generator Script
--#**
--#****************************************************************************
local SShieldStructureUnit = import('/lua/seraphimunits.lua').SShieldStructureUnit

SWSHEILD = Class(SShieldStructureUnit) {
    ShieldEffects = {
