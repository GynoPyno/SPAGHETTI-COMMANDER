#****************************************************************************
#**
#**  File     :  /mods/Hyper Experimental Tier/units/URBCHAD0302/URBCHAD0302_script.lua
#**  Author(s):  Alek Was Here
#**
#**  Summary  :  Cybran Chad Unit Factory Script
#****************************************************************************
local CAirFactoryUnit = import('/lua/cybranunits.lua').CAirFactoryUnit

URBCHAD0302 = Class(CAirFactoryUnit) {
    PlatformBone = 'B01',
