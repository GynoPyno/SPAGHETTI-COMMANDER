#****************************************************************************
#**
#**  File     :  /mods/Hyper Experimental Tier/units/EXSB1302/EXSB1302_script.lua
#**  Author(s):  Cmd Draven
#**
#**  Summary  :  Seraphim Tier 3 Regen Aura Mass Extractor Script
#**
#****************************************************************************
...
EXSB1302 = Class(SMassCollectionUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        if self.AmbientEffects then
            for k, v in EffectTemplate[self.AmbientEffects] do
                CreateAttachedEmitter(self, 'EXSB1302', army, v):ScaleEmitter(1.2)
            end
        end
        ...
        table.insert(self.ShieldEffectsBag, CreateAttachedEmitter(self, 'EXSB1302', self:GetArmy(), '/effects/emitters/seraphim_regenerative_aura_01_emit.bp'))
