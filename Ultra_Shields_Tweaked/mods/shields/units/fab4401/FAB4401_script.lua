#****************************************************************************
#**
#**  File     :  /units/UAB4401/UAB4401_script.lua
#**  Author(s):  David Tomandl, Jessica St. Croix, thebigalex (Edit to Experimental Shield Generator)
#**
#**  Summary  :  Aeon Experimental Shield Generator Script
#**
#**  Copyright � 2005 Gas Powered Games, Inc.  All rights reserved.
#****************************************************************************
local AShieldStructureUnit = import('/lua/aeonunits.lua').AShieldStructureUnit

FAB4401 = Class(AShieldStructureUnit) {
