-- Override di 'U3 SACU Builder' (stock AI-Uveso) — sess.75: esclude gli avamposti
-- (NotOutpost) per evitare che rubino ingegneri/risorse agli avamposti autonomi
-- OverwhelmPlus. Fedele all'originale (AI-Uveso/lua/AI/AIBuilders/SACU.lua) salvo
...
BuilderGroup {
    BuilderGroupName = 'U3 SACU Builder',
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconStorageRatio', { 0.50, 0.75}},
