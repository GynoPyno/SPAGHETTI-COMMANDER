...
function CreateSettingsWindow()
    ...
    settingsWindow = Bitmap(GetFrame(0), UIUtil.UIFile('/mods/Advanced Target Priorities Tweaked/textures/back.dds'))
    ...
    settingsWindow.closeButton =  Button(settingsWindow, 
        UIUtil.UIFile('/mods/Advanced Target Priorities Tweaked/textures/close1.dds'),
        UIUtil.UIFile('/mods/Advanced Target Priorities Tweaked/textures/close1.dds'),
        UIUtil.UIFile('/mods/Advanced Target Priorities Tweaked/textures/close2.dds'),
        UIUtil.UIFile('/mods/Advanced Target Priorities Tweaked/textures/close2.dds'))
    ...
    ---abilities.dds---
    settingsWindow.AbilitiesTexture = Bitmap(settingsWindow, UIUtil.UIFile('/mods/Advanced Target Priorities Tweaked/textures/Abilities.dds'))
