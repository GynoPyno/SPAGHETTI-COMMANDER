#****************************************************************************
#**
#**  File     :  /units/UROW1101/UROW1101_script.lua
#**  Author(s):  David Tomandl, Jessica St. Croix
#**					Modified by Asdrubaelvect
#**  Summary  :  Cybran Anti Orbitals Fighters
#**
...
UROW1101 = Class(CAirUnit) {
    ...
    MovementAmbientExhaustThread = function(self)
		while not self.Dead do
			...
			local ExhaustBeam = '/Mods/OrbitalWarsMod/hook/effects/emitters/cybran_missile_exhaust_fire_beam_12_emit.bp'
