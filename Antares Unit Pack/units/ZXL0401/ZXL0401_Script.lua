...
ZXL0401 = Class(SWalkingLandUnit) {
    SpawnEffects = {
    ...
    Weapons = {
		...
		Upgrade02Gun02 = Class(MiniQuantumBeamGenerator) {},
		Upgrade03Gun01 = Class(MiniQuantumBeamGenerator) {},
		Upgrade03Gun02 = Class(MiniQuantumBeamGenerator) {},
		Upgrade04Gun01 = Class(MiniQuantumBeamGenerator) {},
		Upgrade04Gun02 = Class(MiniQuantumBeamGenerator) {},
    },
