...
UROW1102 = Class(CAirUnit) {
    ...
    Weapons = {
		...
		AntiSpaceShipsGun = Class(CDFMicrowaveLaserGenerator) {},	
    ...
    MovementAmbientExhaustThread = function(self)
		while not self:IsDead() do
			...
			local ExhaustBeam = '/mods/Antares Unit Pack/effects/emitters/cybran_missile_exhaust_fire_beam_13_emit.bp'
