...
LRL4002 = Class(CLandUnit) {
	...
	FxMuzzleFlashScale = 0.2,        
            ...
            PlayFxMuzzleSequence = function(self, muzzle)
                ...
                CreateLightParticleIntel( self.unit, muzzle, self.unit:GetArmy(), 14, 20, 'glow_02', 'ramp_flare_02' )
            end,            
            ...
            CreateProjectileAtMuzzle = function(self, muzzle)
                ...
                RebelArtilleryProtonWeapon.CreateProjectileAtMuzzle(self, muzzle)
            end,
