...
BARFragmentationShell01 = Class(TArtilleryProjectile) {
               
    OnImpact = function(self, TargetType, TargetEntity) 
        
        local FxFragEffect = EffectTemplate.TFragmentationSensorShellFrag 
        local ChildProjectileBP = '/mods/BlackOpsAR/projectiles/BARFragmentationShellChild01/BARFragmentationShellChild01_proj.bp'  
...
TypeClass = BARFragmentationShell01