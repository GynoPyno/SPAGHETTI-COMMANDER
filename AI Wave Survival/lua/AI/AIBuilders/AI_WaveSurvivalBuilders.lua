--[[
    ...
    Author  :   SoftNoob
    Summary :
        All the builders that are used by AI_WaveSurvival.
        The keys for these builders are included AI/AIBaseTemplates/AI_WaveSurvival.lua.
]]
...
--[[BuilderGroup {
    BuilderGroupName = 'AI_WaveSurvivalCommanderBuilder', -- Globally unique key that the AI base template file uses to add the contained builders to your AI.
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Initial Commander BO', -- Names need to be GLOBALLY unique.  Prefixing the AI name will help avoid name collisions with other AIs.
...
BuilderGroup {
    BuilderGroupName = 'AI_WaveSurvivalEngineerBuilder',
    BuildersType = 'EngineerBuilder',
    Builder {
        BuilderName = 'AI_WaveSurvival T1Engineer Mex',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival T1Engineer Pgen',
        PlatoonTemplate = 'EngineerBuilder',
        Priority = 90,
        InstanceCount = 1,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival T1Engineer LandFac',
        PlatoonTemplate = 'EngineerBuilder',
        Priority = 95,
        InstanceCount = 1,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival T1Engineer AirFac',
        PlatoonTemplate = 'EngineerBuilder',
        Priority = 90,
        InstanceCount = 1,
        BuilderConditions = {
...
BuilderGroup {
    BuilderGroupName = 'AI_WaveSurvivalLandBuilder',
    BuildersType = 'FactoryBuilder',
    Builder {
        BuilderName = 'AI_WaveSurvival Factory Engineer',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Factory Scout',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Factory Tank',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Factory Artillery',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Factory AntiAir',
...
BuilderGroup {
    BuilderGroupName = 'AI_WaveSurvivalAirBuilder',
    BuildersType = 'FactoryBuilder',
    Builder {
        BuilderName = 'AI_WaveSurvival Factory Bomber',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Factory Intie',
...
BuilderGroup {
    BuilderGroupName = 'AI_WaveSurvivalPlatoonBuilder',
    BuildersType = 'PlatoonFormBuilder', -- A PlatoonFormBuilder is for builder groups of units.
    Builder {
        BuilderName = 'AI_WaveSurvival Land Attack',
        PlatoonTemplate = 'AI_WaveSurvivalLandAttack', -- The platoon template tells the AI what units to include, and how to use them.
        Priority = 100,
        InstanceCount = 200,
        BuilderType = 'Any',
        BuilderData = {
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Air Attack',
    ...
    Builder {
        BuilderName = 'AI_WaveSurvival Air Intercept',
