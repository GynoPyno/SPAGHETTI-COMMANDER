...
totalT3Navy = 0
totalExpNavy = 0
local NavalPowerAI = 0
HeavyCruMonitior = false
totalT3Sub = 0
totalT3SubDefense = 0
totalExpSub = 0
SubPower = 0
SubFleet = 0
TotalCommandersInWater = 0
AnitAirResponse = 0
totalmass = 0
lastmass = 0
totalIncrease = 0
...
VersesSurvival = 'Versus Survival - Defeat HQ'
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							if LandAmphibious == "All On" then
								if table.find(bp.Categories, 'UEF') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') and not table.find(bp.Categories, 'INTELLIGENCE') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							if LandAmphibious == "All On" then
								if table.find(bp.Categories, 'CYBRAN') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') and not table.find(bp.Categories, 'INTELLIGENCE') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							if LandAmphibious == "All On" then
								if table.find(bp.Categories, 'AEON') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
                ...
                if table.find(bp.Categories, 'LAND') and not table.find(bp.Categories, 'INTELLIGENCE') then
                    ...
                    if id ~= "sbrnt3batu" and id ~= "bel0402" then
                        if LandAmphibious == "All On" then	
							...
							if LandAmphibious == "All On" then
								if table.find(bp.Categories, 'SERAPHIM') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							--Tech3--
							if LandAmphibious == "All On" then --Done
								if table.find(bp.Categories, 'UEF') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and bp.Economy.BuildCostMass <= 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
								if table.find(bp.Categories, 'UEF') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							--Tech3--
							if LandAmphibious == "All On" then --Done
								if table.find(bp.Categories, 'CYBRAN') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and bp.Economy.BuildCostMass <= 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
								if table.find(bp.Categories, 'CYBRAN') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									HlandHeavy = HlandHeavy + 1
									table.insert(landUnitsHHeavy.Tech4, id) --Tech3 T4
								end
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							--Tech3--
							if LandAmphibious == "All On" then --Done
								if table.find(bp.Categories, 'AEON') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and bp.Economy.BuildCostMass <= 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
								if table.find(bp.Categories, 'AEON') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									HlandHeavy = HlandHeavy + 1
									table.insert(landUnitsHHeavy.Tech4, id) --Tech3 T4
								end
				...
				and not table.find(bp.Categories, 'CANTRANSPORTCOMMANDER') then
					if table.find(bp.Categories, 'LAND') then
						...
						if id ~= "sbrnt3batu" and id ~= "bel0402" then
							...
							--Tech3--
							if LandAmphibious == "All On" then --Done
								if table.find(bp.Categories, 'SERAPHIM') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 200 and bp.Economy.BuildCostMass <= 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									Hland = Hland + 1
									table.insert(landUnitsH.Tech4, id) --Tech3
								end
								if table.find(bp.Categories, 'SERAPHIM') and (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass > 3000 and table.find(bp.Categories, 'TECH3') and id ~= "sbrmt3avab" and id ~= "brmt3ava" and id ~= "brot3hades" and id ~= "mantinuke" 
									and id ~= "sbrot3hadesb") then
									HlandHeavy = HlandHeavy + 1
									table.insert(landUnitsHHeavy.Tech4, id) --Tech3 T4
								end
					...
					if table.find(bp.Categories, 'LAND') then
						...
						if (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass <= 3000) then
							if TransportUnits == "Only Bots (Mixed Race)" then	
								...
								and table.find(bp.Categories, 'BOT') and id ~= "uec0001" and id ~= "opc2002" and id ~= "mantinuke" then
									TranHland = TranHland + 1
									table.insert(TransUnitsH.Tech4, id) --TECH2 Units + Garbage
								end
							elseif TransportUnits == "Only Tanks (Mixed Race)" then
								if (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass >= 30) and table.find(bp.Categories, 'TECH3') 
								and table.find(bp.Categories, 'TANK') and id ~= "uec0001" and id ~= "opc2002" and id ~= "mantinuke" then
									TranHland = TranHland + 1
									table.insert(TransUnitsH.Tech4, id) --TECH2 Units + Garbage
								end
							elseif TransportUnits == "Amphibious/Hover (Mixed Race)" then
								if (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass >= 30) and table.find(bp.Categories, 'TECH3') 
								and (table.find(bp.Categories, 'AMPHIBIOUS') or table.find(bp.Categories, 'HOVER')) and id ~= "uec0001" and id ~= "opc2002" and id ~= "mantinuke" then
									TranHland = TranHland + 1
									table.insert(TransUnitsH.Tech4, id) --TECH2 Units + Garbage
								end	
							elseif TransportUnits == "Bots+Tanks (Mixed Race)" then
								if (bp.Economy.BuildCostMass and bp.Economy.BuildCostMass >= 30) and table.find(bp.Categories, 'TECH3') 
								and (table.find(bp.Categories, 'TANK') or table.find(bp.Categories, 'BOT')) and id ~= "uec0001" and id ~= "opc2002" and id ~= "mantinuke" then
									TranHland = TranHland + 1
									table.insert(TransUnitsH.Tech4, id) --TECH2 Units + Garbage
								end	
							end	
		...
		if LAir > 0 and GameTimeAir < (0.1 * WaveProgression) then
			...
			elseif HAir > 0 and GameTimeAir >= (0.35 * WaveProgression) and GameTimeAir < (0.45 * WaveProgression) then
				if EAir > 0 and Random(0, 540) <= 10 * AirExpMulti then -- 0.5% 3% 5.8% x1.5
					if 1 >= Random(0, 10) and AirPowerAI > 0 then
						rspawn = "AAR0310"
					else
            ...
            --if GetGameTimeSeconds() > WavesStartTimeAI then
                ...
                if rspawn ~= nil then
					...
					if unit and unit ~= nil and not unit.Dead then
						...
						if totalVetrancy > 0 then
							if unit.SetVeterancy then 
								unit:SetVeterancy(totalVetrancy)
							end
						end
						if HPBonusAI > 0 or ParagonCycle ~= "Off" then
					...
					if unit and unit ~= nil and not unit.Dead then
						...
						if HPBonusAI > 0 or ParagonCycle ~= "Off" then
							...
							elseif GameTime >= 0.66 and GameTime < 1 then
								...
								unit:SetMaxHealth(maxhp + totalIncrease)
							elseif GameTime >= 1 then
								totalIncrease = HealthBonus * 2 + Random(1200, 2000) * totalEnemyEndgamers
								maxhp = unit:GetMaxHealth()
								unit:SetMaxHealth(maxhp + totalIncrease)
							end	
							hp = unit:GetMaxHealth()
...
function SpawnLandNavy(ship) -- Navy Defense Spawn
    local circle = ForkThread(function(self)
        local unit
        --local goforest = 0
        local rspawn = ship
            ...
            if secondaryspawn ~= "Off" and spawnrateland > 0 and SecondarySpawnDead == false and SecondarySpawnError == false then
					if Alt2ndSpawn ~= "Off" and Alt2ndBuildingDead == false and Random(1, 2) == 1 and Alt2ndSpawnError == false then
						...
						if validPosCount > 0 and Random(1, 4) < 4 then
							...
							posX = (validWaterPositions2.positions2)[Position][1]
							posZ = (validWaterPositions2.positions2)[Position][3]
							SpawnWater = true
						else
							posX, posZ = Alt2ndBrain:GetArmyStartPos()
						end	
				...
				if Random(1, 100) > spawnrateland then
					if AltHQSpawn ~= "Off" and HQAltBuildingDead == false and Random(1, 2) == 1 and AltHQSpawnError == false then
						...
						if validPosCount > 0 and Random(1, 4) < 4 then
							...
							posZ = (validWaterPositions.positions)[Position][3]
							SpawnWater = true
						else	
							posX, posZ = aiBrain:GetArmyStartPos()
						end	
            ...
            --if GetGameTimeSeconds() > WavesStartTimeAI then
                ...
                if rspawn ~= nil then
                    ...
                    if unit and unit ~= nil and not unit.Dead then
						...
						local attachedUnitsCount = Random(2, 3) + ExtraOrbWep
						...
						if bonesCount > 1 then
							repeat
								AttachedAirUnitSpawn(unit, rspawn, "RIFTORB", Random(1, bonesCount - 1))
								WaitTicks(2)
            ...
            if ai_mobile_units then
                for aindex, aUnit in ai_mobile_units do
					if aUnit and not aUnit:BeenDestroyed() then	
						...
						and EntityCategoryContains(categories.COMMAND, aUnit) == false and not aUnit:IsUnitState('Busy') and not aUnit:IsUnitState('Immobile')
		...
		WaitTicks(2)
			if ai_mobile_units3 then --Rambos
                for aindex, aUnit in ai_mobile_units3 do
					--local circle = ForkThread(function(self)
						if aUnit and not aUnit:BeenDestroyed() then
							if aUnit and not aUnit:IsUnitState('Busy') and not aUnit:IsUnitState('Moving') and not aUnit:IsUnitState('Attacking') and not aUnit:IsUnitState('Immobile') and not aUnit:IsUnitState('Patrolling') then
								RedirectRAMBO(aUnit)
							end
						end	
					--end)	
        ...
        --if isAIBrain then
            ...
            if ai_mobile_units then
                for aindex, aUnit in ai_mobile_units do
					if aUnit and not aUnit:BeenDestroyed() then
						if aUnit and EntityCategoryContains(categories.ENGINEER, aUnit) == false
						and EntityCategoryContains(categories.COMMAND, aUnit) == false and not aUnit:IsUnitState('Busy') and not aUnit:IsUnitState('Immobile') and not aUnit:IsUnitState('Moving') and not aUnit:IsUnitState('Attacking') and not aUnit:IsUnitState('Patrolling') then
        ...
        --if isAIBrain then
            ...
            if ai_mobile_units then
                for aindex, aUnit in ai_mobile_units do
					if aUnit and not aUnit:BeenDestroyed() then
						if aUnit and EntityCategoryContains(categories.ENGINEER, aUnit) == false
						and EntityCategoryContains(categories.COMMAND, aUnit) == false and not aUnit:IsUnitState('Busy') and not aUnit:IsUnitState('Immobile') and not aUnit:IsUnitState('Moving') and not aUnit:IsUnitState('Attacking') and not aUnit:IsUnitState('MakingAttackRun') and not aUnit:IsUnitState('Patrolling') then
...
RandomEnemyUnitsSubsList = function(self)
	...
	if table.getn(AllEnemyUnitsSubs) < 1 then
		...
		if table.getn(AllEnemyUnitsSubmersible) > 1 and Random(1, 3) < 3 then
			EnemyUnit = AllEnemyUnitsSubmersible[Random(1, table.getn(AllEnemyUnitsSubmersible))]
		else	
...
RandomEnemyUnitsNavalList = function(self)
	local EnemyUnit = nil
	if table.getn(AllEnemyUnitsNavalShips) < 4 or Random(1, 4) == 3 then
		if table.getn(AllEnemyUnitsNaval) < 3 then
			EnemyUnit = GetRandomEnemyNavalUnit(self)
		else
			EnemyUnit = AllEnemyUnitsNaval[Random(1, table.getn(AllEnemyUnitsNaval))]
		end
	else
		EnemyUnit = AllEnemyUnitsNavalShips[Random(1, table.getn(AllEnemyUnitsNavalShips))]
	end	
	return EnemyUnit
end
GetAllEnemyUnitsLandDefenseList = function(self)
    ...
    for i, brain in humanBrains.HBrains do
		...
		(categories.STRUCTURE * categories.DEFENSE * categories.EXPERIMENTAL) + (categories.MOBILE * categories.EXPERIMENTAL * categories.LAND) + (categories.STRUCTURE * categories.STRATEGIC * categories.SILO) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE), false)
...
GetAllEnemyUnitsLandEconomyList = function(self)
    ...
    for i, brain in humanBrains.HBrains do
        enemyUnitList = brain:GetListOfUnits((categories.STRUCTURE * categories.MASSFABRICATION * categories.TECH3) + (categories.STRUCTURE * categories.FACTORY * categories.TECH3) + categories.SUBCOMMANDER + categories.COMMAND + (categories.STRUCTURE * categories.MASSFABRICATION * categories.TECH2) + (categories.STRUCTURE * categories.MASSFABRICATION * categories.TECH1)
			+ (categories.SILO * categories.TECH3 * categories.STRUCTURE) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) + (categories.STRUCTURE * categories.ENGINEERSTATION) + (categories.STRATEGIC * categories.TECH3 * categories.STRUCTURE) + (categories.STRUCTURE * categories.ENERGYPRODUCTION * categories.TECH3) +
...
GetAllEnemyUnitsBombersList = function(self)
    ...
    for i, brain in humanBrains.HBrains do
		...
		+ (categories.STRUCTURE * categories.STRATEGIC * categories.SILO) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE), false)
		enemyUnitList2 = brain:GetListOfUnits(categories.STRUCTURE * categories.MASSEXTRACTION, false)
		for i = 1, table.getn(enemyUnitList) do
...
GetAllEnemyUnitsSubsList = function(self)
    ...
    for i, brain in humanBrains.HBrains do
        enemyUnitList = brain:GetListOfUnits((categories.MOBILE * categories.NAVAL) + (categories.STRUCTURE * categories.ANTINAVY) + (categories.STRUCTURE * categories.NAVAL), false)
		enemyUnitList2 = brain:GetListOfUnits((categories.STRUCTURE * categories.MASSEXTRACTION) + categories.COMMAND + categories.SUBCOMMANDER, false)
		enemyUnitList3 = brain:GetListOfUnits((categories.MOBILE * categories.NAVAL * categories.SUBMERSIBLE), false)
		for i = 1, table.getn(enemyUnitList) do
			AllEnemyUnitsSubs[table.getn(AllEnemyUnitsSubs) + 1] = enemyUnitList[i]
		end
		for i = 1, table.getn(enemyUnitList3) do
			AllEnemyUnitsSubmersible[table.getn(AllEnemyUnitsSubmersible) + 1] = enemyUnitList3[i]
		end
		for i = 1, table.getn(enemyUnitList2) do
			local aUnit = enemyUnitList2[i]
			if aUnit ~= nil and (aUnit:GetCurrentLayer() == "Sub" or aUnit:GetCurrentLayer() == "Seabed") then
...
GetAllEnemyUnitsNavalList = function(self)
    ...
    for i, brain in humanBrains.HBrains do
		...
		(categories.STRUCTURE * categories.MASSPRODUCTION * categories.MASSEXTRACTION) + (categories.AMPHIBIOUS * categories.MOBILE * categories.LAND * categories.ANTINAVY), false)
		for i = 1, table.getn(enemyUnitList) do
			AllEnemyUnitsNaval[table.getn(AllEnemyUnitsNaval) + 1] = enemyUnitList[i]
		end
		enemyUnitList2 = brain:GetListOfUnits((categories.MOBILE * categories.NAVAL), false)
		for i = 1, table.getn(enemyUnitList2) do
			AllEnemyUnitsNavalShips[table.getn(AllEnemyUnitsNavalShips) + 1] = enemyUnitList2[i]
		end
    end
end
...
GetAllEnemyUnitsForDooms = function(self)
	...
	local EnemyUnit = nil
    for i, brain in humanBrains.HBrains do
        enemyUnitList = brain:GetListOfUnits(categories.COMMAND + (categories.SILO * categories.TECH3 * categories.STRUCTURE) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) + (categories.STRATEGIC * categories.TECH3 * categories.STRUCTURE) + (categories.STRUCTURE * categories.EXPERIMENTAL * categories.DEFENSE) +
...
GetAllEnemyUnitsForArtillery = function(self)
	...
	local EnemyUnit = nil
    for i, brain in humanBrains.HBrains do
        enemyUnitList = brain:GetListOfUnits((categories.SILO * categories.TECH3 * categories.STRUCTURE) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) + (categories.STRATEGIC * categories.TECH3 * categories.ARTILLERY) + (categories.STRUCTURE * categories.EXPERIMENTAL * categories.ORBITALSYSTEM) +
...
GetAllEnemyUnitsForNukes = function(self)
	...
	local EnemyUnit = nil
    for i, brain in humanBrains.HBrains do
        enemyUnitList = brain:GetListOfUnits((categories.SILO * categories.TECH3 * categories.STRUCTURE) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) + (categories.STRATEGIC * categories.TECH3 * categories.STRUCTURE) + (categories.STRUCTURE * categories.EXPERIMENTAL * categories.DEFENSE) +
...
GetAllEnemyUnitsNaval = function(self)
	...
	if table.getn(AllEnemyUnits2) < 3 or Random(1, 3) == 2 then
		if table.getn(AllEnemyUnits) < 2 then
			EnemyUnit = GetRandomEnemyNavalUnit(self)
		else	
			EnemyUnit = AllEnemyUnits[Random(1, table.getn(AllEnemyUnits))]
		end	
	else
		EnemyUnit = AllEnemyUnits2[Random(1, table.getn(AllEnemyUnits2))]
	end
	return EnemyUnit
end
...
GetRandomEnemy4LandBossUnit = function(self) --
    ...
    huBrain = GetRandomCloseAliveEnemyBrain(self)
    if huBrain and not huBrain:IsDefeated() then
        local huUnitsList = huBrain:GetListOfUnits((categories.STRUCTURE * categories.DEFENSE * categories.TECH3 * categories.DIRECTFIRE) + categories.COMMAND + categories.SUBCOMMANDER + (categories.SILO * categories.TECH3 * categories.STRUCTURE) + (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) + 
...
GetRandomEnemy4EndGameBossUnit = function(self) --
    ...
    if huBrain and not huBrain:IsDefeated() then
		...
		(categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) +  
...
GetRandomEnemyNavalUnit = function(self) --
    ...
    if huBrain and not huBrain:IsDefeated() then
        ...
        closestEnemyUnit = huUnitsList[Random(1, table.getn(huUnitsList))]
		if table.getn(huUnitsList) < 1 or Random(1, 4) == 1 then
...
function MonitoringTeamElimination()
	...
	local errorcheck = false
		WaitSeconds(10)
		PrintText("==Versus Survival - HQ Suicides is ON. Requires 3+ Teams or 3+ FFA to work.==", 28, 'ffff9393', 6, 'center')
        repeat
			WaitSeconds(10)
			local HQEnemies = 0
			for i, brain in humanBrains.HBrains do
			...
			if GetGameTimeSeconds() < WavesStartTimeAI and HQEnemies == 0 and errorcheck == false then
				PrintText("==WARNING: 'Versus Survival - HQ Suicides' requires a minimum of 3 Teams or 3 FFA==", 28, 'ffCC0000', 15, 'center')
				PrintText("In 'Versus Survival - HQ Suicides', HQ Team suicides when only one other Team is left standing.", 28, 'ffCC0000', 15, 'center')
				AIMessageTo('Error: "Versus Survival - HQ Suicides" requires 3 or more teams. Scenario defaulting back to "Versus Survival - Defeat HQ".', nil)
				PrintText("NOTE: Game has defaulted back to 'Versus Survival - Defeat HQ'.", 26, 'ffff9393', 15, 'center')
				PrintText("Requires last Team standing to Kill HQ to win.", 26, 'ffff9393', 15, 'center')
				errorcheck = true
			end	
			...
			if HQEnemies == 0 and errorcheck == false then
				ClearAIAllUnits()
			end
        until GetGameTimeSeconds() > 20000
    end)
...
function FindNavalUnits()
    local circle = ForkThread(function(self)
		...
		for i, brain in humanBrains.HBrains do
			PlayersNavy = aiBrain:GetListOfUnits((categories.MOBILE * categories.EXPERIMENTAL * categories.NAVAL) + (categories.MOBILE * categories.EXPERIMENTAL * categories.NAVAL) + (categories.MOBILE * categories.TECH2 * categories.NAVAL) + (categories.MOBILE * categories.TECH3 * categories.NAVAL), false) 
			if brain and not brain:IsDefeated() then
				for i = 1, table.getn(PlayersNavy) do
					AllTeamsNavy[table.getn(AllTeamsNavy) + 1] = PlayersNavy[i]
				end
			end	
		end
		--count = table.getn(AllTeamsNavy)
		--AIMessageTo('Naval Unit Count: ', count)
		LOG("NavalResponse List")
		for i = 1, table.getn(AllTeamsNavy) do
			unit = AllTeamsNavy[i]
...
function MonitoringFunctionFive() -- Damage Bonus
	local circle = ForkThread(function(self)
		repeat
			...
			if totalEnemyMass >= 2000 then
				totalVetrancy = math.floor(totalEnemyMass * 0.0005 + 0.0005)
				totalVetrancyHunters = math.floor(totalEnemyMass * 0.0004 + 0.0004)
				if totalVetrancy > 5 then
					totalVetrancy = 5
				end	
				if totalVetrancyHunters > 5 then
					totalVetrancyHunters = 5
				end
				if (totalEnemyMass / humans) > 2000 then
					DoomOrbsFlag = true
				else
					DoomOrbsFlag = false
				end
			...
			if totalEnemyMass > (250 * humans) then
				ExtraOrbWep = math.floor((totalEnemyMass - (100 * humans)) * 0.0004 + 0.0005)
				if DamageBoost ~= 'Off - 0' then
	...
	local circle = ForkThread(function(self)
		repeat
			...
			totalT3Bombers = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH3 * categories.AIR * categories.BOMBER)
				--totalAirPowerAI = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.AIR)
			AirPowerAI = math.floor((totalExpAir * 34) + (totalT3Gunships * 2) + (totalT3Fighters * 0.34) + (totalT3Bombers * 1.75) + 0.5)
...
function MonitoringFunctionSeven() --Navy Counter
	local circle = ForkThread(function(self)
		repeat
			WaitSeconds(60)
			local totalT1Navy = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH1 * categories.NAVAL) 
			local totalExpNavy = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.EXPERIMENTAL * categories.NAVAL) 
			if totalExpNavy >= 1 then
				totalExpNavy = totalExpNavy - 1
			end	
			local totalT2Navy = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH2 * categories.NAVAL)
			local totalT3Navy = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH3 * categories.NAVAL)
			NavalPowerAI = 0
...
function MonitoringFunctionSubFleet() --Sub Spam Counter
	local circle = ForkThread(function(self)
		repeat
			...
			--totalT1Navy = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH1 * categories.NAVAL) 
			totalExpSub = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.EXPERIMENTAL * categories.NAVAL * categories.SUBMERSIBLE) 
			if totalExpSub >= 1 and humans < 6 then
				totalExpSub = totalExpSub - 1
			elseif totalExpSub >= 1 and humans > 5 then
				totalExpSub = totalExpSub - 2
					if totalExpSub < 0 then
						totalExpSub = 0
					end	
			end	
			totalT3SubDefense = CalculateTotalEnemyUnitsOfCategory(self, (categories.SUBMERSIBLE * categories.TECH3 * categories.DEFENSE * categories.STRUCTURE) + categories.xrb2309)
			--PrintText("Total Harms Are  " .. totalT3SubDefense .. " !", 28, 'ffCBFFFF', 4, 'center') 
			--totalT2Navy = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH2 * categories.NAVAL)
			totalT3Sub = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.TECH3 * categories.NAVAL * categories.SUBMERSIBLE)
				--totalAirPowerAI = CalculateTotalEnemyUnitsOfCategory(self, categories.MOBILE * categories.AIR)
			SubPower = math.floor((totalExpSub * 12) + (totalT3Sub * 3) + (totalT3SubDefense * 3) + 0.5)
			TotalCommandersInWater = math.floor((acuWaterCount * 12) + (sacuWaterCount * 3))
		until GetGameTimeSeconds() > 20000 or won == true
	  end)
end
	...
	local circle = ForkThread(function(self)
		repeat
			...
			if GetGameTimeSeconds() > (WavesStartTimeAI + (HoldTimeAI * 0.6)) then
				if (AirPowerAI > (46 + (humans * 4)) and totalNomanders < (math.floor(humans * 0.25 + 0.25) + 3)) or (AirPowerAI > (46 + (humans * 4)) and Random(1, 20) == 10) then
					PrintText("ALERT! AntiAir Detected!", 28, 'ffCBFFFF', 4, 'center') 
					AnitAirResponse =  math.floor(math.floor(AirPowerAI * 0.035 + 0.5) * tonumber(ScenarioInfo.Options.NomanderSpawn) + 0.5)
					repeat
						ANTIAIRResponseWave()
...
function MonitorInterceptedRifts()
    local circle = ForkThread(function(self)
		local interceptedRifts
		local unit
		local count
		...
		repeat
			--LOG("sa: Running MonitorRiftBuildingCount")
			interceptedRifts = {}
			interceptedRifts = aiBrain:GetListOfUnits(categories.rmarker, false)
			count = table.getn(interceptedRifts)
			InterceptedRiftCount = InterceptedRiftCount + count
			for i, unit in interceptedRifts do
				WaitSeconds(20)
...
function CreateARiftNuke(SupportBase)
    local circle = ForkThread(function(self)
        ...
        if SupportBase and not SupportBase:BeenDestroyed() then
			...
			local rspawn
			if InterceptedRiftCount > 2 then
				rspawn = "RIFTNUKE2"
				PrintText("Warning! SMD is being JAMMED!", 24, 'ffFF1100', 4, 'center')
				AIMessageTo('Warning! SMD is being JAMMED by incoming Rift Nuke!', nil)
				InterceptedRiftCount = 0
			else
				rspawn = "RIFTNUKE"
			end
...
function DetectAircraftCarriers()
    local circle = ForkThread(function(self)
	local carrier
	local wavesize
	...
	local carrierlist
		...
		repeat
			...
			carrierlist = {}
			carrierlist = aiBrain:GetListOfUnits(categories.CARRIER * categories.MOBILE * categories.NAVAL, false)
			--totalEnemyMass = CalculateEnemyMass()
			--UnitsFromMass = math.floor((totalEnemyMass * 0.00134) + 0.5)
			for i, carrier in carrierlist do
				if carrier and not carrier:BeenDestroyed() then
					wavesize = math.floor(Random(1, 4) * CarriersSpawnAir + 0.5)
					if wavesize < 1 then
						wavesize = 1
					end	
					PrepareAircraftForCarrier(carrier, wavesize)
				end
			end	
...
function PrepareAircraftForCarrier(carrier, wavesize)
	local circle = ForkThread(function(self)
		--LOG("sa: Running CreateWavesForOrbRift Size " .. wavesize)
		local ship = carrier
		local posX, posY, posZ = ship:GetPositionXYZ()
		local unitcount = wavesize
		local SubTotal = TotalCommandersInWater + SubPower
		repeat
			SpawnAirUnitsForCarrier(posX, posZ, SubTotal)
...
function SpawnAirUnitsForCarrier(RposX, RposZ, SubTotal)
	local circle = ForkThread(function(self)
		local unit = nil
		local rspawn = nil
		local posX = RposX
		local posZ = RposZ
		local SubPower = SubTotal
		--if GetGameTimeSeconds() > WavesStartTimeAI then
		if TotalMayhemWaves == "Adjustable T1/T2/T3 Experimentals" then 
			if HAirHeavy > 0 and Random(1, 40) <= TotalMayhemAir then
				rspawn = (HAirUnitsHeavy.Tech4)[Random(1, HAirHeavy)]
			else
				if SubPower > Random(1, 165) then
					rspawn = "XAA0306"
				else	
					rspawn = (HAirUnits.Tech4)[Random(1, HAir)]
				end
...
function DetectHeavyCruisers()
	...
	local carrierlist
		...
		repeat
			--LOG("sa: Running DetectAndSpawnOrbRiftWaves")
			carrierlist = {}
			carrierlist = aiBrain:GetListOfUnits(categories.lbs0201, false)
			--totalEnemyMass = CalculateEnemyMass()
			--UnitsFromMass = math.floor((totalEnemyMass * 0.00134) + 0.5)
			if NavalPowerAI > 200 then
				for i, carrier in carrierlist do
					if carrier and not carrier:BeenDestroyed() then
						wavesize = math.floor(Random(1, 2) + (NavalPowerAI * 0.00125 + 0.001))
						if wavesize > 10 then
							wavesize = 10
						end
						PrepareAircraftForCruisers(carrier, wavesize)
					end
				end
			end	
			WaitSeconds(Random(60, 120))	
...
function PrepareAircraftForCruisers(carrier, wavesize)
	local circle = ForkThread(function(self)
		--LOG("sa: Running CreateWavesForOrbRift Size " .. wavesize)
		local ship = carrier
		local posX, posY, posZ = ship:GetPositionXYZ()
		...
		--local SubTotal = TotalCommandersInWater + SubPower
		repeat
			SpawnAirUnitsForCruisers(posX, posZ)
			unitcount = unitcount - 1
			WaitTicks(5)
		until unitcount < 1 or won == true
		KillThread(self)
...
function SpawnAirUnitsForCruisers(RposX, RposZ)
	local circle = ForkThread(function(self)
		local unit = nil
		local rspawn = nil
		local posX = RposX
...
function MonitoringNearbyEnemyUnitsFunction() -- Defensive
    local circle = ForkThread(function()
		if sizeX == 256 or sizeZ == 256 then
			AIMessageTo('Defensive Nukes disabled due to map size.', nil)
		else
			repeat
				WaitSeconds(Random(Nukex1, Nukex2))
                ...
                if HQUnit and not HQUnit:BeenDestroyed() then
                    if huUnit and not huUnit:BeenDestroyed() then
                        ...
                        if distance < closestDistance then
							...
							AIMessageTo('Notice: Units near HQ will trigger a defensive nuke strike. Defensive Nukes can be disabled in settings.', nil)
                            closestEnemyUnit = huUnit
                            return closestEnemyUnit
                        end
                    end
...
function SubResponseSpawnHQSubs()  -- Spawns response subs for HQ
    local circle = ForkThread(function()
		local validPosCount = table.getn(validWaterPositions.positions)
		if validPosCount > 0 then
			local Position = Random(1, validPosCount)
			local validPosX = (validWaterPositions.positions)[Position][1]
			local validPosZ = (validWaterPositions.positions)[Position][3]
			SpawnEnemyUnitAtPosition("XSS0304", validPosX, validPosZ, 0, 0)
		end
	end)
end	
function SubResponseSpawn2ndSpawnSubs()  -- Spawns response subs for 2nd spawn
    local circle = ForkThread(function()
		local validPosCount = table.getn(validWaterPositions2.positions2)
		if validPosCount > 0 then
			local Position = Random(1, validPosCount)
			local validPosX = (validWaterPositions2.positions2)[Position][1]
			local validPosZ = (validWaterPositions2.positions2)[Position][3]
			SpawnEnemyUnitAtPosition("XSS0304", validPosX, validPosZ, 0, 0)
		end
	end)
end	
		...
		--repeat
			...
			repeat
				if Random(1, 4) <= 3 then
					...
					local RiftSpawnCnt = Random(1, table.getn(validRiftPositions.positions))
					validPosX = (validRiftPositions.positions)[RiftSpawnCnt][1]
					validPosZ = (validRiftPositions.positions)[RiftSpawnCnt][3]
				end
    ...
    local circle = ForkThread(function(self)
        ...
        if GetGameTimeSeconds() > WavesStartTimeAI then
            ...
            if rspawn ~= nil then
                local oldposX = posX
                local oldposZ = posZ
                unit = aiBrain:CreateUnitNearSpot(rspawn, oldposX, oldposZ)
                if unit == nil then
                    local posX = oldposX
                    local posZ = oldposZ
						Chance = Random(1, 8)
...
CalculateTotalEnemySMDs = function(self)
    ...
    for i, brain in humanBrains.HBrains do
        if not IsAlly(aiBrain:GetArmyIndex(), brain:GetArmyIndex()) then
            local SMDs = brain:GetListOfUnits((categories.TECH3 * categories.DEFENSE * categories.ANTIMISSILE * categories.SILO) + (categories.EXPERIMENTAL * categories.DEFENSE * categories.ANTIMISSILE * categories.SILO), false)
...
function MonitoringAISecondaryBuildings() --Monitors Support Bases Count
	if SecondaryBuildingFlag ~= "Off" then
		local circle = ForkThread(function(self)
			...
			if TotalCountSupportBases < 2 then
				TotalCountSupportBases = 2
...
function MainAIPowerCrash()
	local circle = ForkThread(function(self)
		if SecondaryBuildingsDead == true then
			HQPowerStallMessage()
			AIMessageTo('HQ Shields down! Hit HQ while you can!', nil)
			...
			repeat
				...
				aiBrain:GiveResource('ENERGY', -100000)
				WaitTicks(10)
			until GetGameTimeSeconds() > stalltime
			--WaitSeconds(PowerStallTime)
			AIMainBuilding:SetProductionPerSecondEnergy(HQEnergy)
			AIMainBuilding:SetConsumptionPerSecondEnergy(0)
			aiBrain:GiveResource('ENERGY', 500000)
			AIMessageTo('HQ Power Restored.', nil)
			MainAIRepeatPowerCrash()
		end
		KillThread(self)
	end)
end	
function MainAIRepeatPowerCrash()
	local circle = ForkThread(function(self)
		WaitSeconds(60)
		repeat
			WaitSeconds(120, 240)
			HQPowerStallMessage()
			AIMessageTo('HQ Shields down! Hit HQ while you can!', nil)
			local stalltime = GetGameTimeSeconds() + Random(15, 40)
			repeat
				AIMainBuilding:SetProductionPerSecondEnergy(0)
				AIMainBuilding:SetConsumptionPerSecondEnergy(1000000)
				aiBrain:GiveResource('ENERGY', -100000)
...
function RandomEffectBuildingDestroyed()
	...
	local chance
			...
			if Random(1, 10) <= 6 or SideObjsDestroyed > gurantee or GetGameTimeSeconds() < WavesStartTimeAI then
...
function GrantResources()
	local circle = ForkThread(function(self)
		local count = 20 + (SideObjsDestroyed * 12)
		local SupplyMass = count * 250
		local brain
		PrintText("Resupply Underway.", 28, 'ff0914E8', 6, 'center')
		AIMessageTo('Total Mass to be Supplied: ', SupplyMass)
			repeat
				for i, brain in humanBrains.HBrains do
					WaitTicks(1)
					if brain and not brain:IsDefeated() then
						local army = brain
						army:GiveResource('MASS', 250)
						army:GiveResource('ENERGY', 18750)
					end
				end
				WaitTicks(5)
				count = count - 1
...
function DamageHQEffect()
	...
	local Damage = 0.05
		if AIMainBuilding ~= nil and not AIMainBuilding:BeenDestroyed() then
			...
			HQhp = math.floor(HQCurrentHP - HQDamage)
			if HQhp > 0 then
...
function ArtilleryRetaliation(num)
	...
	local count = 1 + num
		...
		AIMessageTo('Survive Artillery Barrage for 5 Minutes!', nil)
		repeat
        ...
        if aliveBrain then
            ...
            if rspawn ~= nil then
				...
				if unit and unit ~= nil and not unit.Dead then
					...
					unit:SetReclaimable(false)
					local attachedUnitsCount = Random(2, 3)
					local bonesCount = unit:GetBoneCount()
					if bonesCount > 1 then
						repeat
							AttachedLandUnitSpawn(unit, rspawn, "RIFTORB", Random(1, bonesCount - 1))
							WaitTicks(2)
							attachedUnitsCount = attachedUnitsCount - 1
						until attachedUnitsCount < 1
					end
        ...
        if aliveBrain then
            ...
            if rspawn ~= nil then
				...
				if unit and unit ~= nil and not unit.Dead then
					...
					unit:SetReclaimable(false)
					local attachedUnitsCount = Random(3, 4)
					local bonesCount = unit:GetBoneCount()
					if bonesCount > 1 then
						repeat
							if EntityCategoryContains(categories.LAND, unit) == true then
								AttachedLandUnitSpawn(unit, rspawn, "RIFTORB", Random(1, bonesCount - 1))
							else
								AttachedAirUnitSpawn(unit, rspawn, "RIFTORB", Random(1, bonesCount - 1))
							end
...
function CreatACUHunterUnit(unitId)
    local circle = ForkThread(function(self)
        ...
        if unit and unit ~= nil and not unit.Dead then
			if totalVetrancyHunters > 0 then
				if unit.SetVeterancy then 
					unit:SetVeterancy(totalVetrancyHunters)
				end
			end
			if HPBonusAI > 0 or ParagonCycle ~= "Off" then
				totalIncrease = HealthBonus
...
function CreateACombinedLandBossUnitAroundMainBuildingForAI() --Minor Boss Land
    local circle = ForkThread(function(self)
        ...
        if unit ~= nil then
            ...
            local attachedUnitsCount = Random(2, 3) + math.floor(totalEnemyYolonas * 0.33 + 0.5) + ExtraOrbWep
            if attachedUnitsCount > 6 then
                attachedUnitsCount = 6
            end
            local bonesCount = unit:GetBoneCount()
            if bonesCount > 1 then
				--if EntityCategoryContains(categories.BOT, unit) == true then
					repeat
						...
						--[[if Random(1, 2) == 2 then	
							...
							AttachedLandUnitSpawn(unit, rspawn, "XSL0307", Random(1, bonesCount - 1))
						end	]]--
						AttachedLandUnitSpawn(unit, rspawn, "RIFTORB", Random(1, bonesCount - 1))
						WaitTicks(2)
						attachedUnitsCount = attachedUnitsCount - 1
...
function CreateACombinedAirBossUnitAroundMainBuildingForAI()  --Endgame Boss Air
    local circle = ForkThread(function(self)
        ...
        if unit ~= nil then
            ...
            local bonesCount = unit:GetBoneCount()
			local orbcount = 2 + attachedUnitsCount
			local t4attached = false
            if bonesCount > 1 then
                repeat
					if t4attached == false then
						if airUnitsA and airUnitsA.Tech4 and countair > 0 then
							AttachedAirUnitSpawn(unit, rspawn, (airUnitsA.Tech4)[Random(1, countair)], Random(1, bonesCount - 1))
						end	
						t4attached = true
                    elseif airUnitsA and airUnitsA.Tech4 and countair > 0 and Random(1, 2) == 1 then
                        AttachedAirUnitSpawn(unit, rspawn, (airUnitsA.Tech4)[Random(1, countair)], Random(1, bonesCount - 1))
                    end
                    WaitTicks(2)
                    attachedUnitsCount = attachedUnitsCount - 1
				...
				repeat
					...
					orbcount = orbcount - 1
				until orbcount < 1
				if DoomOrbsFlag == true then
					if Random(1, 20) == 10 then
						AttachedAirUnitSpawn(unit, rspawn, "DOOMORB", Random(1, bonesCount - 1))
						AIMessageTo('Enhanced Boss Detected!', nil)
					end	
				end
            end
			if DamageBoost ~= 'Off - 0' then
...
function CreateAirBossUnitForYolonas()  --Endgame Boss for Yolo Script Air
    local circle = ForkThread(function(self)
        ...
        if unit ~= nil then
            ...
            local bonesCount = unit:GetBoneCount()
            local orbcount = 4 + attachedUnitsCount
			local t4attached = false
            if bonesCount > 1 then
                repeat
					if t4attached == false then
...
function CreateHugeBossUnitAroundMainBuildingForAI() --EndGame Boss Land
    local circle = ForkThread(function(self)
        ...
        if unit ~= nil then
            ...
            unit:SetHealth(self, hp)
			local Pos1x, Pos1y, Pos1z = unit:GetPositionXYZ()
            local attachedUnitsCount = Random(3, 5) + math.floor(totalEnemyYolonas * 0.33 + 0.5) + ExtraOrbWep
            ...
            if bonesCount > 1 then
                --if EntityCategoryContains(categories.BOT, unit) == true then
					...
					if DoomOrbsFlag == true then
						if Random(1, 20) == 10 then
							AttachedLandUnitSpawn(unit, rspawn, "DOOMORB", Random(1, bonesCount - 1))
							AIMessageTo('Enhanced Boss Detected!', nil)
						end	
					end
				--end	
            ...
            WaitTicks(5)
            unit:SetCustomName("EndGame Boss")
            unit:SetSpeedMult(0.9 + (waveNum * SpeedBonus + SpeedBonusOnce) * 0.3)
            if WaveStyle == "Even Attack Waves" then	
				RedirectUnitEndgameBoss(unit)
			elseif WaveStyle == "Dynamic Attack Waves" or WaveStyle == "Human with AI Assist" then
				RedirectUnitEndgameBoss(unit)
...
function CreateHugeBossForYolonas() -- Endgame Boss for Yolos Land
    local circle = ForkThread(function(self)
        ...
        if unit ~= nil then
            ...
            unit:SetHealth(self, hp)
			local Pos1x, Pos1y, Pos1z = unit:GetPositionXYZ()
            local attachedUnitsCount = Random(5, 8) + math.floor(totalEnemyYolonas * 0.33 + 0.5) + ExtraOrbWep
            if attachedUnitsCount > 12 then
                attachedUnitsCount = 12
            end
            local bonesCount = unit:GetBoneCount()
            ...
            WaitTicks(5)
            unit:SetCustomName("Yolo Boss")
            unit:SetSpeedMult(1.2 + (waveNum * SpeedBonus + SpeedBonusOnce) * 0.3)
            if WaveStyle == "Even Attack Waves" then	
				RedirectDoomWalker(unit)
			elseif WaveStyle == "Dynamic Attack Waves" or WaveStyle == "Human with AI Assist" then
				RedirectDoomWalker(unit)
...
function CreateDoomBoss(DoomMass) --Endgame Doom Boss
    local circle = ForkThread(function(self)
        WaitTicks(50)
		local DoomHPBonus
        local rspawn
        ...
        if unit ~= nil then
            ...
            local attachedUnitsCount = 5 + math.floor(totalEnemyYolonas * 0.33 + 0.5) + ExtraOrbWep
            if attachedUnitsCount > 8 then
                attachedUnitsCount = 8
            end
            local bonesCount = unit:GetBoneCount()
            if bonesCount > 1 then
                repeat
...
function DeployDooms() --Begin Doom Wave
	local circle = ForkThread(function(self)
		...
		ExpectedDooms = count
		repeat
			CreateDoomBoss(totalEnemyMass)
			count = count - 1
		until count < 1	
		if HQAlert == true then
			PrintText("===Final Doom Wave Deployed!===", 28, 'ffCBFFFF', 10, 'center')
		else
			PrintText("===Doom Wave Deployed!===", 28, 'ffCBFFFF', 10, 'center')
		end	
		AIMessageTo('Total Dooms Deployed: ', ExpectedDooms)
		if DoomOrbsFlag == true then
			AIMessageTo('Warning! Doom Weapons Enhanced!', nil)
		end	
...
function MonitorSpirits() --Monitor Spirits
	local circle = ForkThread(function(self)
		local ActiveSpirits
		table.insert(DoomRamboTable, 'UEL0301_RAMBO')
		table.insert(DoomRamboTable, 'URL0301_RAMBO')
		table.insert(DoomRamboTable, 'XSL0301_RAMBO')
		repeat
			ActiveSpirits = nil
...
function MonitorDoomWave() --Monitor Dooms
	local circle = ForkThread(function(self)
		...
		local HQhp
		local HQAlmostDead
		local DoomsCount = ExpectedDooms
		local FinalHealth = false
		local FinalHealthHP
		repeat
			WaitSeconds(2)
			...
			if ExpectedDooms > TotalDooms then
				if TotalDooms > 0 then
					AIMessageTo('Dooms Remaining: ', TotalDooms)
					if DoomStorm ~= "Off --" and Random(1, 10) == 1 then
						DoomElectronStormsSpawner()
					end	
				else
					AIMessageTo('Doom Wave Defeated!', nil)
				end
				if HQAlert == false then
					if DoomDamageHQ > 0 then
						if AIMainBuilding ~= nil and not AIMainBuilding:BeenDestroyed() then
							HQMaxHP = AIMainBuilding:GetMaxHealth()
							HQCurrentHP = AIMainBuilding:GetHealth()
							HQDamage = math.floor(MainBuildingHPAI * DoomDamageHQ * (1 / DoomsCount) * (ExpectedDooms - TotalDooms) + 0.5)
							HQhp = math.floor(HQCurrentHP - HQDamage)
							if HQhp > 0 then
								AIMainBuilding:SetHealth(self, HQhp)
								PrintText("Doom Destroyed! HQ Damaged! " .. HQhp .. " Health!", 28, 'ffCBFFFF', 6, 'center')
								AIMessageTo('Current HQ health is ', HQhp)
							end	
						end
					end	
				else
					if DoomDamageHQ > 0 then 
						if AIMainBuilding ~= nil and not AIMainBuilding:BeenDestroyed() then
							--HQMaxHP = AIMainBuilding:GetMaxHealth()
							if FinalHealth == false then
								FinalHealthHP = AIMainBuilding:GetHealth()
								FinalHealth = true
							end
							HQCurrentHP = AIMainBuilding:GetHealth()
							HQDamage = math.floor(FinalHealthHP * (1 / DoomsCount) * (ExpectedDooms - TotalDooms) + 0.5)
							HQhp = math.floor(HQCurrentHP - HQDamage)
							if HQhp > 0 then
								AIMainBuilding:SetHealth(self, HQhp)
								PrintText("Doom Destroyed! HQ Damaged! " .. HQhp .. " Health!", 28, 'ffCBFFFF', 6, 'center')
				...
				ExpectedDooms = TotalDooms
			end
			--PrintText("Total Dooms " .. TotalDooms .. " !", 28, 'ffCBFFFF', 6, 'center')
		until TotalDooms == 0	
		--HQ Check/Damage
		HQAlmostDead = math.floor(HQhp - (MainBuildingHPAI * DoomDamageHQ + 1))
		if (DoomStorm ~= "Off --" and Random(1, 10) <= 5) or (HQAlmostDead <= 0 and DoomStorm ~= "Off --") then --and Random(1, 2) == 2
			if HQAlert == false then
				DoomElectronStormsSpawner()
			end	
		end	
			...
			for aindex, sBuilding in aiSecondaryBuildings.secondaryBuildings do
				...
				local testunit = (aiSecondaryBuildings.secondaryBuildings)[buildingcount]
                    ...
                    if unitIda == nil or unitIda == "" then
						if not testunit:BeenDestroyed() and (NavyPerWave > 0 or HeavyCruMonitior == true) and (testunit:GetCurrentLayer() == "Water") and Random(1, 2) == 1 then
							unitIda = "XRB2308"
		...
		if spirit and not spirit:BeenDestroyed() then
			...
			if TotalMayhemWaves == "Adjustable T1/T2/T3 Experimentals" then
				if BigRiftHland > 0 and  Random(1, 40) <= TotalMayhemLand then
					...
					if Random(1, 12) == 6 then
						rspawn = (DoomRamboTable)[Random(1, 3)]
					else	
						rspawn = (RiftUnitsH.Tech4)[Random(1, RiftHland)]
					end	
				end	
...
function CreateAndLaunchNukeAtEnemy()
    local circle = ForkThread(function(self)
        ...
        if unit ~= nil then
			...
			local position = targetedUnit:GetPosition()
            WaitTicks(20)
            if targetedUnit then
                IssueNuke({ unit }, position)
            end
            WaitTicks(750)
            if unit ~= nil and not unit:BeenDestroyed() then
				unit:Kill()
...
GetRandomEnemyDefenseUnitNuke = function(self)
    ...
    if huBrain and not huBrain:IsDefeated() then
		...
		if table.getn(huUnitsList) < 1 then
			...
			+ (categories.DEFENSE * categories.TECH3 * categories.SILO * categories.ANTIMISSILE) + (categories.SILO * categories.TECH3 * categories.STRUCTURE), false)
			enemyUnit = huUnitsList[Random(1, table.getn(huUnitsList))]
		end
		if table.getn(huUnitsList) < 1 then
...
function GameOver()
	...
	AIMessageTo('End Game Artillery in Mins: ', timeInMin)
    BroadcastMSG(message, size, color, fade, alignment)
    WaitTicks(Random(25))
end
...
function GameStartMessage() --Message for Game Stats
	...
	local AirDelay
		...
		if RiftUnits ~= "Off --" and SecondaryBuildingFlag ~= "Off" then
...
function CreateEngiStationsForAI() --Not used
    local circle = ForkThread(function(self)
        local unit = nil
        local posX, posZ = aiBrain:GetArmyStartPos()
        if GetGameTimeSeconds() > WavesStartTimeAI then
        ...
        if GetGameTimeSeconds() > 0 then
            ...
            if rspawn ~= nil then
				...
				elseif TranSpawnLocation == "Center Only" then
					RanNum = 5
				elseif TranSpawnLocation == "From the HQ" then
					RanNum = 6
				end	
	...
	local transport
        ...
        if GetGameTimeSeconds() > 0 then
			...
			if unit and unit ~= nil and not unit.Dead then
				if unit.SetVeterancy then 
					if GameTime < 1 then
						unit:SetVeterancy(Random(2, 5))
					else
						unit:SetVeterancy(Random(4, 5))
					end
				end
				if HPBonusAI > 0 or ParagonCycle ~= "Off" then
					if GameTime < 0.33 then
...
function InitSurvival()
	...
	SubResponseEnabled = tostring(ScenarioInfo.Options.SubResponseEnabled)
	...
	CarriersSpawnAir = tostring(ScenarioInfo.Options.CarriersSpawnAir)
	WreckDespawn = tostring(ScenarioInfo.Options.WreckDespawn)
	WreckReclaim = tostring(ScenarioInfo.Options.WreckReclaim)
	
	LOG("===== AI Wave Survival Settings =====")
	LOG("UEF RACE On/Off: " .. UEFWaves)
	LOG("CYBRAN RACE On/Off: " .. CybranWaves)
	LOG("AEON RACE On/Off: " .. AeonWaves)
	LOG("SERAPHIM RACE On/Off: " .. SeraphimWaves)
	LOG("NOMADS RACE On/Off: " .. NomadWaves)
	LOG("==== HQ SETTINGS ====")
	LOG("HQ Spawn Spot: " .. AIWavePlayer)
	OptionsSetting = tostring(ScenarioInfo.Options.MainBuildingHPAI)
	LOG("HQ Health (millions): " .. OptionsSetting)
	LOG("HQ Alternate Spawn (Optional): " .. AltHQSpawn)
	LOG("HQ Alternate Health: " .. AltHQHealth)
	LOG("HQ Shields/SMD/TMD Defenses: " .. HQDefenses)
	LOG("HQ Point Defenses: " .. HQDefensesPD)
	LOG("HQ/2ndSpawn Base Building On/Off: " .. KillAIBase)
	LOG("===== 2ND SPAWN SETTINGS =====")
	LOG("2nd Spawn Spot (Optional): " .. secondaryspawn)
	OptionsSetting = tostring(ScenarioInfo.Options.SecSpawnBuildingHP)
	LOG("2nd Spawn Health (millions): " .. OptionsSetting)
	LOG("2nd Spawn Alternate (Optional): " .. Alt2ndSpawn)
	LOG("2nd Spawn Alternate Health: " .. Alt2ndHealth)
	LOG("2nd Spawn Shields/SMD Defenses: " .. SecSpawnDefences)
	LOG("2nd Spawn Point Defenses: " .. SecSpawnPD)
	LOG("1a. 2nd Spawn Land Percent: " .. spawnrateland)
	LOG("1b. Recover Land to HQ Spawn: " .. permanentwaveloss)
	LOG("2a. 2nd Spawn Air Percent: " .. spawnrateair)
	LOG("2b. Recover Air to HQ Spawn: " .. permanentwavelossair)
	LOG("3a. 2nd Spawn Navy Percent: " .. spawnratenavy)
	LOG("3b. Recover Navy to HQ Spawn: " .. permanentwavelossnavy)
	LOG("===== SALVATION PLAYER =====")
	LOG("Salvation Player Slot: " .. salvationspawn)
	LOG("Salvation Destruction: " .. salvationBOOM)
	LOG("===== WIN/LOSE/VERSUS SETTINGS =====")
	LOG("Hold to Win On/Off: " .. EndGameHoldTime)
	OptionsSetting = tostring(ScenarioInfo.Options.TorpBomberStartTime)
	LOG("Hold to Win Torp Bombers: " .. OptionsSetting)
	LOG("Defeat Conditions: " .. KillAllNonHQPlayers)
	LOG("Defeat Conditions: HQ Allies: " .. KillHQPlayerAllies)
	LOG("Versus Survival On/Off: " .. VersesSurvival)
	OptionsSetting = tostring(ScenarioInfo.Options.KillPlayerUnit)
	LOG("Versus Suicide Timer: " .. OptionsSetting)
	LOG("===== WAVE SETUP =====")
	LOG("Wave Style: " .. WaveStyle)
	OptionsSetting = tostring(ScenarioInfo.Options.WavesStartTimeAI)
	LOG("1a: Build Time (mins): " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.AirTime)
	LOG("1b: Air Delay Spawn Time: " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.NavyTime)
	LOG("1c: Naval Delay Spawn Time: " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.DelayUntilNextWaveAI)
	LOG("2: Delay between Waves (mins): " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.HoldTimeAI)
	LOG("3a: Hold Until (mins): " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.GameBreak)
	LOG("3b: Endgame Wave Break: " .. OptionsSetting)
	LOG("4: Wave Tech Progression: " .. WaveProgressionData)
	LOG("5: Start Waves at Tech 2: " .. JumpTech2)
	LOG("6a: LAND UNITS Per Player: " .. LandPerWave)
	LOG("6b: LAND Amphibious/AntiAir On/Off: " .. LandAmphibious)
	LOG("6c: LAND Amphibious Check: " .. AmphibiousCheck)
	LOG("6d: LAND Wave Size Multiply: " .. WaveSizeMultiLand)
	OptionsSetting = tostring(ScenarioInfo.Options.ExpMulti)
	LOG("6e: LAND Experimental/Boss Frequency: " .. OptionsSetting)
	LOG("7a: AIR UNITS Per Player: " .. AirPerWave)
	LOG("7b: AIR ASF & Torp Bombers On/Off: " .. ASFWaves)
	LOG("7c: AIR Wave Size Multiply: " .. WaveSizeMultiAir)
	OptionsSetting = tostring(ScenarioInfo.Options.AirExpMulti)
	LOG("7d: AIR Experimental/Boss Frequency: " .. OptionsSetting)
	LOG("8a: NAVAL UNITS Per Player: " .. NavyPerWave)
	LOG("8b: NAVAL Wave Size Multiply: " .. WaveSizeMultiNaval)
	OptionsSetting = tostring(ScenarioInfo.Options.NavyExpMulti)
	LOG("8c: NAVAL Experimental Frequency: " .. OptionsSetting)
	LOG("9: Land/Air/Navy Experimentals On/Off: " .. ExperimentalSpawns)
	LOG("10: Special Option for Unit Packs: " .. TotalMayhemWaves)
	OptionsSetting = tostring(ScenarioInfo.Options.TotalMayhemLand)
	LOG("10a: Land T1/T2/T3 Experimental Frequency: " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.TotalMayhemAir)
	LOG("10b: Air T1/T2/T3 Experimental Frequency: " .. OptionsSetting)
	OptionsSetting = tostring(ScenarioInfo.Options.TotalMayhemNavy)
	LOG("10c: Navy T1/T2/T3 Experimental Frequency: " .. OptionsSetting)
	LOG("===== SPEED/HP SETTINGS =====")
	LOG("BOOST: HP Bonus: " .. HPBonusAI)
	LOG("BOOST: Incremental Speed: " .. SpeedBonus)
	LOG("BOOST: Single SpeedBoost: " .. SpeedBonusOnce)
	LOG("BOOST: Damage Amplification: " .. DamageBoost)
	LOG("===== AIRDROPS =====")
	LOG("DROPS: Airdrops On/Off: " .. TransportFrequency)
	LOG("DROPS: Airdrops per Wave: " .. InitialTransports)
	LOG("DROPS: Airdrops Wave Multiply: " .. TransportMultiplier)
	LOG("DROPS: Airdrops Start Time: " .. TransportsToStartTime)
	LOG("DROPS: Airdrops End Time: " .. TransportEndTime)
	LOG("DROPS: Airdrops Unit Types: " .. TransportUnits)
	LOG("DROPS: Airdrops RAMBOS: " .. RamboChance)
	LOG("DROPS: Airdrops Experimentals: " .. TransportExpChance)
	LOG("DROPS: Airdrops Spawn Location: " .. TranSpawnLocation)
	LOG("===== EXTRA WAVES/RESPONSE =====")
	LOG("1: Minor Boss Units On/Off: " .. MinorBossSpawns)
	LOG("2a: AntiAir Response Wave: " .. NomanderSpawn)
	LOG("2b: Extra ASF: " .. ExtraASFEnabled)
	LOG("3: Extra Sub Response: " .. SubResponseEnabled)
	LOG("4: Carriers Spawn Air: " .. CarriersSpawnAir)
	LOG("5a: ACU Hunters: " .. ACUHunterTime)
	LOG("5b: ACU Hunters Wave Multi: " .. ACUHunterSize)
	LOG("6a: Paragon Punishment: " .. ParagonCycle)
	LOG("6b: Paragon Nuke: " .. ParagonNuke)
	LOG("7: Yolona+Artillery Response: " .. ArtyYolo)
	LOG("SB1: Spawn Support Bases: " .. SecondaryBuildingFlag)
	LOG("SB2: Support Bases Multipler: " .. SupportBaseMulti)
	LOG("SB3: Nuke Retaliation: " .. SupportBaseNukes)
	OptionsSetting = tostring(ScenarioInfo.Options.PowerStallTime)
	LOG("SB4: HQ Player Power Stall: " .. OptionsSetting)
	LOG("SB5: Rift Orbs: " .. RiftUnits)
	LOG("===== ENDGAME SETTINGS =====")
	LOG("1a: Endless Land/Air/Navy Waves: " .. Endless)
	LOG("1b: Endless Delay (Mins): " .. ExtraWaveDelay)
	LOG("2a: BOSS LAND Units: " .. EndWaveMulti)
	LOG("2b: BOSS AIR Units: " .. EndWaveAir)
	LOG("2c: BOSS Endless Final Wave: " .. BossWaveEndlessSpawn)
	LOG("3a: ARTILLERY Endgame On/Off: " .. ArtyOn)
	OptionsSetting = tostring(ScenarioInfo.Options.ArtySpawnTime)
	LOG("3b: ARTILLERY Endgame Spawn Time: " .. OptionsSetting)
	LOG("3c: ARTILLERY EndGame Type: " .. ArtyType)
	LOG("4a: DOOM EndGame Wave: " .. DoomCount)
	OptionsSetting = tostring(ScenarioInfo.Options.DoomDamageHQ)
	LOG("4b: DOOM HQ Damage: " .. OptionsSetting)
	LOG("4c: DOOM Wave +/-: " .. DoomIncrease)
	LOG("4d: DOOM Minimum Wave Size: " .. DoomMinimum)
	LOG("4e: DOOM Maximum Wave Size: " .. DoomMaximum)
	OptionsSetting = tostring(ScenarioInfo.Options.DoomBoostHP)
	LOG("4f: DOOM Health Boost: " .. OptionsSetting)
	LOG("4g: DOOM Storm Spawn: " .. DoomStorm)
	LOG("4h: DOOM Crawlers On/Off: " .. DoomCrawlers)
	LOG("4i: DOOM Walkers On/Off: " .. DoomWalkers)
	LOG("5a: Allied Reinforcements: " .. SpawnAlliesForceFlag)
	LOG("5b: Allied Force Multiplier: " .. AlliedForceMultiplier)
	LOG("===== ECO BOOST SETTINGS =====")
	LOG("ECO 1: Starting ACU EcoBoost, 0 = Off: " .. HumanEcoBoost)
	LOG("ECO 2a: Endgame EcoBoost, 0 = Off: " .. EndGameEcoBoost)
	OptionsSetting = tostring(ScenarioInfo.Options.EndEcoBoostTime)
	LOG("ECO 2b: Endgame EcoBoost Start Time: " .. OptionsSetting)
	LOG("ECO 3: HQ Allies EcoBoost, 0 = Off: " .. HQAllyEcoBoost)
	LOG("ECO 4a: Wreck Removal: " .. WreckDespawn)
	LOG("ECO 4b: Wreck Reclaim Rate: " .. WreckReclaim)
	LOG("ECO 5a: HQ Mass Production: " .. HQMass)
	LOG("ECO 5b: HQ Energy Production: " .. HQEnergy)
	LOG("===== NUKE STRIKE SETTINGS =====")
	LOG("NUKE: Strikes On/Off: " .. NukesOn)
	LOG("NUKE: Strikes Start Time: " .. NukeTime)
	LOG("NUKE: Strike Frequency: " .. NukeStrikeEveryAI)
	LOG("NUKE: Nukes Per Strike: " .. NukesPerStrikeAI)
	LOG("NUKE: Increase Nukes Per Strike: " .. NukeIncreasePerStrike)
	LOG("NUKE: Nuclear Overwhelm: " .. NuclearOverwhelm)
	LOG("===== BUILD RESTRICTIONS =====")
	LOG("BUILD: Max Hives Per Player: " .. HivesPerPlayerAI)
	LOG("BUILD: Paragon On/Off: " .. EndGameParagon)
	LOG("BUILD: Yolona On/Off: " .. EndGameYolo)
	LOG("BUILD: T4AA + EMP Tacs On/Off: " .. SpecialWeapons)
	LOG("BUILD: Buildable Arty/Nukes/Sat: " .. ArtyNukeEnable)
	LOG("BUILD: HQ Allies Restrictions: " .. HQAllyRestrict)
	LOG("===== SPECIAL SETTINGS =====")
	LOG("Land Crazy Mode: " .. CrazyModeLand)
	LOG("Air Crazy Mode: " .. CrazyModeAir)
	LOG("Navy Crazy Mode: " .. CrazyModeNavy)
	AIMessageTo('All configuartion settings saved to LOG file.', nil)
	...
	if salvationspawn ~= "Off" and SalvationCheck == false and salvationspawn ~= "Half of Team" then
		...
		AIMessageTo('ERROR: Set Salvation Player in Map Options.', nil)
	end
	...
	if aBrainsHQ > 0 and AIWavePlayer ~= "Random" then 
		...
		elseif ErrorMessage == false then
			...
			AIMessageTo('NOTICE: HQ Allies may be set as additional Spawn Points in Map Options.', nil)
		end
	end	
	...
	MonitoringFunctionFive() --damage boost and mass monitor
	if DoomCount ~= 'Off --' then
	...
	if VersesSurvival == 'Versus Survival - HQ Suicides' then	
		MonitoringTeamElimination()
	end
	if NavyPerWave == 0 then --Navy Response Monitor
		MonitoringFunctionSeven()
	end
	--Support Bases
	...
	if NavyPerWave > 0 then	
		...
		if SubResponseEnabled ~= "Off --" or CarriersSpawnAir ~= "Off --" then
			...
			if SubResponseEnabled ~= "Off --" then
				SubResponseEnabled = tonumber(ScenarioInfo.Options.SubResponseEnabled)
				SubFleet = 21 + (humans * 3)
			end
			if CarriersSpawnAir ~= "Off --" then
				CarriersSpawnAir = tonumber(ScenarioInfo.Options.CarriersSpawnAir)
				DetectAircraftCarriers()
			end
		end
	end	
	...
	if AIWavePlayer == "Random" then
		PrintText("==NOTICE: HQ is Set to Random==", 28, 'ffffa548', 20, 'center')
		PrintText("--HQ Player spot can be set in Map Options--", 28, 'ffffa548', 20, 'center')
		AIMessageTo('HQ set to Random. A random player on the SMALLEST team will be given HQ.', nil)
	end

    repeat
		if SecondaryBuildingFlag ~= "Off" then
			if GetGameTimeSeconds() < WavesStartTimeAI and ActivateWavesAI == false then
			local count1 = math.floor(WavesStartTimeAI * 0.5)
				repeat
					if SideObjsDestroyed > 1 then
						PrintText("EARLY WAVES ACTIVATED", 30, 'ffCBFFFF', 4, 'center')
						ActivateWavesAI = true
					end
					WaitTicks(20)
					count1 = count1 - 1
				until count1 < 1 or ActivateWavesAI == true
			end
        elseif GetGameTimeSeconds() < WavesStartTimeAI then
			WaitSeconds(WavesStartTimeAI)
		end
        ...
        if (GetGameTimeSeconds() < (HoldTimeAI + WavesStartTimeAI)) or (Endless ~= "Off" and GetGameTimeSeconds() > WavesStartTimeAI) then
					...
					if NavyPerWave == 0 or NavalFallback == true then
						...
						if NavalPowerAI > 100 then
							if HeavyCruMonitior == false then
								DetectHeavyCruisers()
								AIMessageTo('Naval Response is Active!', nil)
								--FindNavalUnits()
								HeavyCruMonitior = true
							end	
							local count = math.floor(NavalPowerAI * 0.01 + 0.5)
							GetListsOfNavyTargets()
							repeat
								if GameTime <= 0.33 then
								...
								elseif GameTime > 0.33 and GameTime <= 0.67 then
									if Random(1, 10) < 7 then
										unit = "URS0201"
									else --30%
										unit = "LBS0201"
									end
								elseif GameTime > 0.67 and GameTime <= 1 then
									if Random(1, 10) < 6 then
										unit = "URS0201"
									else --40%
										unit = "LBS0201"
									end
								elseif GameTime > 1 and GameTime <= 1.33 then
									if Random(1, 10) < 5 then
										unit = "URS0201"
									else --50%
										unit = "LBS0201"
									end	
								elseif GameTime > 1.33 then
									if Random(1, 5) < 2 then
										unit = "URS0201"
									else --60%
										unit = "LBS0201"
			...
			or (AirPerWave > 0 and GetGameTimeSeconds() > (WavesStartTimeAI + AirTime) and (Endless == "Land+Air+Navy" or Endless == "Land+Air" or Endless == "Air+Navy" or Endless == "Air")) then	
				local circle = ForkThread(function(self)
					...
					until AirCount < 1
					if AirPowerAI > 20 and ExtraASFEnabled ~= "Off --" then
