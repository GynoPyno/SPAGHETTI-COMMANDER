...
#**  Author(s):  John Comes, Gordon Duclos  modded by bbkineebee
#**
#**  Summary  :  Aeon Galactic Colossus Script (Gigantic Colossus)
#**
...
GGA0004 = Class(AWalkingLandUnit) {
    Weapons = {
    ...
    DeathThread = function( self, overkillRatio , instigator)
        ...
        WaitSeconds(0.3)
        explosion.CreateDefaultHitExplosionAtBone( self, 'Right_Arm_B01', 2.0 )
        explosion.CreateDefaultHitExplosionAtBone( self, 'Right_Leg_B01', 2.0 )

        WaitSeconds(3.5)
        explosion.CreateDefaultHitExplosionAtBone( self, 'Torso', 10.0 )        
