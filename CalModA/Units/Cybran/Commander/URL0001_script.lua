...
URL0001 = ClassUnit(ACUUnit, CCommandUnit) {
    Weapons = {
        ...
        Blastwave = Class(CIFArtilleryWeapon) {},
    ...
    OnStopBeingBuilt = function(self, builder, layer)
        ...
        self:SetWeaponEnabledByLabel('Blastwave', false)
    ...
    CreateEnhancement = function(self, enh)
        ...
        elseif enh == 'EMPCharge' then                                       #Gun2 EMP
        ...
        elseif enh == 'Blastwave' then   
            self:SetWeaponEnabledByLabel('Blastwave', true)                            #BlastWave
        elseif enh == 'BlastwaveRemove' then
            self:SetWeaponEnabledByLabel('Blastwave', false)             
