...
URB4204 = Class(CShieldStructureUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        self.Rotator1 = CreateRotator(self, 'Shaft', 'z', nil, 100, 30, 100)
    ...
    OnShieldEnabled = function(self)
        ...
        if self.Rotator1 then
            self.Rotator1:SetTargetSpeed(100)
        end
        ...
        for k, v in self.ShieldEffects do
            table.insert( self.ShieldEffectsBag, CreateAttachedEmitter( self, 'Shaft', self:GetArmy(), v ):ScaleEmitter(0.4) )
        end
    end,
