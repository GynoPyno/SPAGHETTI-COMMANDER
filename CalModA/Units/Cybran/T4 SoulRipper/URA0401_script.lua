...
URA0401 = Class(CAirUnit) {
    Weapons = {
        Missile01 = Class(CDFProtonCannonWeapon) {},
        Missile02 = Class(CDFProtonCannonWeapon) {},
        HeavyBolter = Class(CDFProtonCannonWeapon){},
        RightHeavyBolter = Class(CDFProtonCannonWeapon){},
        LeftHeavyBolter = Class(CDFProtonCannonWeapon){},
    ...
    OnCreate = function(self)
        ...
        self:HideBone('Back_Turret_Barrel01', true)		
