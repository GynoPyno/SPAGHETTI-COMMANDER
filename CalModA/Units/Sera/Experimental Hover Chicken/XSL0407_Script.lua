...
XSL0401 = Class(SWalkingLandUnit) {
    ...
    OnCreate = function(self)
            ...
            self:HideBone('Right_Foot', true)
            self:HideBone('Right_Leg_B01', true)
            self:HideBone('Right_Leg_B02', true)
            self:HideBone('Left_Foot', true)
            self:HideBone('Left_Leg_B14', true)
            self:HideBone('Left_Leg_B17', true)
    end,		
