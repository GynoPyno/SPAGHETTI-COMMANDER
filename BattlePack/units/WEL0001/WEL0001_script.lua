...
local BattlePackWeaponsFile = import('/lua/BattlePackweapons.lua')
local SC2ZephyrCannonWeapon = BattlePackWeaponsFile.SC2ZephyrCannonWeapon

WEL0001 = Class(TWalkingLandUnit) {    
    DeathThreadDestructionWaitTime = 2,

    Weapons = {
        DeathWeapon = Class(DeathNukeWeapon) {},
        RightZephyr = Class(SC2ZephyrCannonWeapon) {},
		...
		ArtillleryGun = Class(TIFArtilleryWeapon) {}
    },
    ...
    OnCreate = function(self)
		...
		self:HideBone('AAUpgrade', true)
		self:HideBone('ArtyUpgrade', true)
		self:HideBone('RightPodUpgrade', true)
		self:HideBone('LeftPodUpgrade', true)
    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		self:SetWeaponEnabledByLabel('ArtillleryGun', false)
    ...
    WarpInEffectThread = function(self)
        ...
        WaitSeconds(2.1)
        self:SetMesh('/units/WEL0001/WEL0001_PhaseShield_mesh', true)
    ...
    CreateEnhancement = function(self, enh)
        ...
        elseif enh =='AAGunRemove' then
            self:SetWeaponEnabledByLabel('AAGun', false)
		elseif enh =='ArtyGun' then
            self:SetWeaponEnabledByLabel('ArtillleryGun', true)
        elseif enh =='ArtyGunRemove' then
            self:SetWeaponEnabledByLabel('ArtillleryGun', false)
		elseif enh =='MobilitySystem' then
			self:SetSpeedMult(1.5)
        elseif enh =='MobilitySystemRemove' then
			self:SetSpeedMult(1)
